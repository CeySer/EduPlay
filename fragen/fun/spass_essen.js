...
const SPASS_ESSEN_QUESTIONS = [
  ...
  { id: "q1400", category: "spass_essen", area: "spass", subject: "essen", question: "Aus welchem Land stammt die Pizza ursprünglich?", answers: ["Italien", "Griechenland", "Spanien", "Türkei"], correct: 0, difficulty: "mittel", points: 10, explanation: "Die Pizza Margherita stammt aus Neapel und trägt die Farben Italiens." },
  { id: "q1401", category: "spass_essen", area: "spass", subject: "essen", question: "Woraus wird Schokolade hergestellt?", answers: ["Aus Kakaobohnen", "Aus Kaffeebohnen", "Aus Nüssen", "Zuckerrüben"], correct: 0, difficulty: "mittel", points: 10, explanation: "Kakaobohnen wachsen an Kakaobäumen in tropischen Regionen." },
  { id: "q1402", category: "spass_essen", area: "spass", subject: "essen", question: "Welches Gemüse macht beim Schneiden oft die Augen tränen?", answers: ["Zwiebel", "Karotte", "Gurke", "Kartoffel"], correct: 0, difficulty: "mittel", points: 10, explanation: "Beim Schneiden werden reizende Schwefelverbindungen freigesetzt." },
  { id: "q1403", category: "spass_essen", area: "spass", subject: "essen", question: "Was ist Sushi hauptsächlich?", answers: ["Reis mit Fisch oder Gemüse", "Gebratene Nudeln", "Ein Suppengericht", "Frittierte Kartoffeln"], correct: 0, difficulty: "mittel", points: 10, explanation: "'Sushi' bezieht sich eigentlich auf den gesäuerten Reis." },
  { id: "q1404", category: "spass_essen", area: "spass", subject: "essen", question: "Welches Getränk wird aus Gerste, Hopfen, Hefe und Wasser gebraut?", answers: ["Bier", "Wein", "Limonade", "Saft"], correct: 0, difficulty: "mittel", points: 10, explanation: "Das deutsche Reinheitsgebot von 1516 nennt genau diese Zutaten." },
  { id: "q1405", category: "spass_essen", area: "spass", subject: "essen", question: "Woraus besteht Guacamole hauptsächlich?", answers: ["Avocado", "Erbsen", "Brokkoli", "Spinat"], correct: 0, difficulty: "mittel", points: 10, explanation: "Guacamole ist eine mexikanische Creme aus Avocado, Limette und Zwiebel." },
  ...
  { id: "q1408", category: "spass_essen", area: "spass", subject: "essen", question: "Wie heißt das japanische Wort für grünen Pulvertee?", answers: ["Matcha", "Mango", "Miso", "Wasabi"], correct: 0, difficulty: "mittel", points: 10, explanation: "Matcha wird aus fein gemahlenen Grünteeblättern zubereitet." },
  { id: "q1409", category: "spass_essen", area: "spass", subject: "essen", question: "Welches Lebensmittel besteht zu über 90 Prozent aus Wasser?", answers: ["Gurke", "Brot", "Käse", "Reis"], correct: 0, difficulty: "mittel", points: 10, explanation: "Gurken bestehen zu etwa 95 Prozent aus Wasser." },
  { id: "q1410", category: "spass_essen", area: "spass", subject: "essen", question: "Was ist Hummus?", answers: ["Eine Creme aus Kichererbsen", "Ein Fleischgericht", "Eine Süßspeise", "Ein Nudelgericht"], correct: 0, difficulty: "mittel", points: 10, explanation: "Hummus wird aus Kichererbsen, Sesampaste, Zitrone und Knoblauch gemacht." },
  { id: "q1411", category: "spass_essen", area: "spass", subject: "essen", question: "Welcher Käse hat traditionell Löcher?", answers: ["Emmentaler", "Gouda", "Feta", "Camembert"], correct: 0, difficulty: "mittel", points: 10, explanation: "Die Löcher entstehen durch Gasbildung bestimmter Bakterien beim Reifen." },
