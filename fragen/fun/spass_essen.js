...
const SPASS_ESSEN_QUESTIONS = [
  ...
  { id: "q1400", category: "spass_essen", area: "spass", subject: "essen", question: "Aus welchem Land stammt die Pizza ursprünglich?", answers: ["Türkei", "Spanien", "Italien", "Griechenland"], correct: 2, difficulty: "mittel", points: 10, explanation: "Die Pizza Margherita stammt aus Neapel und trägt die Farben Italiens." },
  { id: "q1401", category: "spass_essen", area: "spass", subject: "essen", question: "Woraus wird Schokolade hergestellt?", answers: ["Aus Kaffeebohnen", "Aus Nüssen", "Zuckerrüben", "Aus Kakaobohnen"], correct: 3, difficulty: "mittel", points: 10, explanation: "Kakaobohnen wachsen an Kakaobäumen in tropischen Regionen." },
  { id: "q1402", category: "spass_essen", area: "spass", subject: "essen", question: "Welches Gemüse macht beim Schneiden oft die Augen tränen?", answers: ["Karotte", "Kartoffel", "Zwiebel", "Gurke"], correct: 2, difficulty: "mittel", points: 10, explanation: "Beim Schneiden werden reizende Schwefelverbindungen freigesetzt." },
  { id: "q1403", category: "spass_essen", area: "spass", subject: "essen", question: "Was ist Sushi hauptsächlich?", answers: ["Ein Suppengericht", "Reis mit Fisch oder Gemüse", "Gebratene Nudeln im Alltag", "Frittierte Kartoffeln"], correct: 1, difficulty: "mittel", points: 10, explanation: "'Sushi' bezieht sich eigentlich auf den gesäuerten Reis." },
