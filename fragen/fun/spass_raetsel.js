...
const SPASS_RAETSEL_QUESTIONS = [
  ...
  { id: "q1446", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Was wird nasser, je mehr es trocknet?", answers: ["Ein Handtuch", "Ein Stein", "Ein Schuh", "Ein Regenschirm"], correct: 0, difficulty: "mittel", points: 10, explanation: "Je mehr es abtrocknet, desto nasser wird es selbst." },
  { id: "q1447", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Ein Bauer hat 17 Schafe. Alle bis auf 9 laufen weg. Wie viele bleiben?", answers: ["9", "8", "17", "18"], correct: 0, difficulty: "mittel", points: 10, explanation: "'Alle bis auf 9' heißt: genau 9 bleiben übrig." },
  { id: "q1448", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Was hat Städte, aber keine Häuser, und Wasser, aber keine Fische?", answers: ["Eine Landkarte", "Ein Buch", "Ein Fernseher", "Eine Zeitung"], correct: 0, difficulty: "mittel", points: 10, explanation: "Auf einer Landkarte sind Städte und Flüsse eingezeichnet." },
  { id: "q1449", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Wie viele Monate haben 28 Tage?", answers: ["Alle 12", "Nur einer", "Zwei", "Sechs"], correct: 0, difficulty: "mittel", points: 10, explanation: "Jeder Monat hat mindestens 28 Tage." },
  { id: "q1450", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Was geht hoch, wenn der Regen runterkommt?", answers: ["Der Regenschirm", "Der Boden", "Die Sonne", "Die Temperatur"], correct: 0, difficulty: "mittel", points: 10, explanation: "Ein kleines Wortspiel-Rätsel." },
  ...
  { id: "q1452", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Setze fort: 1, 1, 2, 3, 5, 8, ...", answers: ["13", "11", "16", "18"], correct: 0, difficulty: "mittel", points: 10, explanation: "Fibonacci-Folge: Jede Zahl ist die Summe der beiden vorherigen." },
  ...
  { id: "q1455", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Vater und Sohn sind zusammen 60 Jahre. Der Vater ist dreimal so alt. Wie alt ist der Sohn?", answers: ["15", "20", "12", "23"], correct: 0, difficulty: "mittel", points: 10, explanation: "Sohn 15, Vater 45 – zusammen 60 und dreimal so alt." },
  { id: "q1456", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Wie oft kann man 10 von 100 abziehen?", answers: ["Einmal, danach ist es 90", "Zehnmal", "Unendlich oft", "Genau fünfmal"], correct: 0, difficulty: "mittel", points: 10, explanation: "Beim zweiten Mal zieht man ja von 90 ab, nicht mehr von 100." },
  { id: "q1457", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Was kann man fangen, aber nicht werfen?", answers: ["Eine Erkältung", "Einen Ball", "Einen Stein", "Ein Nickerchen"], correct: 0, difficulty: "mittel", points: 10, explanation: "Man 'fängt sich' eine Erkältung ein." },
  { id: "q1458", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Was hat einen Anfang, eine Mitte und ein Ende, aber keinen Körper?", answers: ["Ein Wort", "Ein Buch", "Ein Tag", "Eine Geschichte"], correct: 0, difficulty: "mittel", points: 10, explanation: "Ein Wort hat Anfang, Mitte und Ende – aber keinen physischen Körper." },
  { id: "q1459", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Was gehört einem Menschen, wird aber von anderen mehr benutzt?", answers: ["Der Name", "Die Zeit", "Das Geld", "Das Gesicht"], correct: 0, difficulty: "mittel", points: 10, explanation: "Der eigene Name gehört einem – aber andere benutzen ihn häufiger." },
  { id: "q1460", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Was kann man essen, aber nicht kochen?", answers: ["Eiscreme", "Salat", "Obst", "Eine Banane"], correct: 0, difficulty: "mittel", points: 10, explanation: "Eiscreme wird gegessen, aber nicht gekocht – sie wird gefroren." },
  { id: "q1461", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Was hat viele Löcher, aber hält Wasser?", answers: ["Ein Schwamm", "Ein Sieb", "Ein Netz", "Ein Eimer"], correct: 0, difficulty: "mittel", points: 10, explanation: "Ein Schwamm hat viele kleine Löcher und kann trotzdem Wasser aufnehmen." },
  { id: "q1462", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Was ist größer als die Ewigkeit, aber kleiner als ein Tropfen?", answers: ["Nichts", "Die Liebe", "Die Zeit", "Ein Gedanke"], correct: 0, difficulty: "mittel", points: 10, explanation: "Nichts ist größer als alles und kleiner als alles – ein klassisches Rätsel." },
  { id: "q1463", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Was wird kürzer, wenn man es verlängert?", answers: ["Der Tag", "Das Leben", "Ein Seil", "Eine Kerze"], correct: 0, difficulty: "mittel", points: 10, explanation: "Wenn man den Tag verlängert, wird die Nacht kürzer – eine spielerische Antwort." },
  { id: "q1464", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Was hat Schlüssel, aber keine Schlösser?", answers: ["Ein Keyboard", "Ein Haus", "Ein Auto", "Ein Klavier"], correct: 0, difficulty: "mittel", points: 10, explanation: "Ein Keyboard hat Tasten (Keys), aber keine Schlösser." },
  { id: "q1465", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Was ist immer vor dir, aber du kannst es nicht sehen?", answers: ["Die Zukunft", "Die Vergangenheit", "Das Licht", "Der Wind"], correct: 0, difficulty: "mittel", points: 10, explanation: "Die Zukunft ist immer vor dir – aber man kann sie nicht sehen." },
  { id: "q1466", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Was hat einen Kopf und einen Schwanz, aber keinen Körper?", answers: ["Eine Münze", "Ein Brief", "Ein Tier", "Ein Komet"], correct: 0, difficulty: "mittel", points: 10, explanation: "Eine Münze hat Kopf (Bild) und Zahl (Schwanz), aber keinen Körper." },
  { id: "q1467", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Was wird größer, je mehr man davon nimmt?", answers: ["Ein Loch", "Ein Berg", "Ein Blatt", "Eine Schuld"], correct: 0, difficulty: "mittel", points: 10, explanation: "Je mehr man von einem Loch wegnimmt, desto größer wird es." },
  { id: "q1468", category: "spass_raetsel", area: "spass", subject: "raetsel", question: "Was hat Zähne, aber kann nicht beißen?", answers: ["Ein Kamm", "Ein Säge", "Ein Löwe", "Ein Reißverschluss"], correct: 0, difficulty: "mittel", points: 10, explanation: "Ein Kamm hat Zähne, aber er kann nicht beißen." },
