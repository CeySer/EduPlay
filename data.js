...
const QUESTIONS_DATABASE = [
    ...
    { category: "k1_deutsch", question: "Welcher Buchstabe ist ein Vokal (Selbstlaut)?", answers: ["A", "B", "C"], correct: 0, explanation: "A ist ein Selbstlaut, die anderen sind Mitlaute." },
    { category: "k1_deutsch", question: "Mit welchem Buchstaben beginnt das Wort 'Tiger'?", answers: ["T", "I", "G"], correct: 0, explanation: "Tiger beginnt mit dem Buchstaben T." },
    { category: "k1_deutsch", question: "Wie heißt der erste Buchstabe im Alphabet?", answers: ["A", "B", "C"], correct: 0, explanation: "A ist der erste Buchstabe im ABC." },
    { category: "k1_deutsch", question: "Reimt sich 'Welt' auf?", answers: ["Geld", "Haus", "Buch"], correct: 0, explanation: "Welt und Geld klingen am Ende gleich." },
    { category: "k1_deutsch", question: "Wie viele Buchstaben hat das Wort 'Ei'?", answers: ["2", "3", "1"], correct: 0, explanation: "E-I sind zwei Buchstaben." },
    ...
    { category: "k1_mathe", question: "Was ist 2 + 5?", answers: ["6", "7", "8"], correct: 1, explanation: "2 und 5 zusammen ergeben 7." },
    { category: "k1_mathe", question: "Was ist 9 - 3?", answers: ["5", "6", "7"], correct: 1, explanation: "Von 9 drei weggenommen bleiben 6." },
    { category: "k1_mathe", question: "Welche Zahl kommt vor der 10?", answers: ["8", "9", "11"], correct: 1, explanation: "Die 9 kommt direkt vor der 10." },
    { category: "k1_mathe", question: "Was ist 1 + 1?", answers: ["1", "2", "3"], correct: 1, explanation: "1 und 1 ergibt 2." },
    { category: "k1_mathe", question: "Zähle bis 5. Welche Zahl fehlt: 1, 2, 3, __, 5?", answers: ["4", "6", "0"], correct: 0, explanation: "Nach der 3 kommt die 4." },
    ...
    { category: "k1_sachunterricht", question: "Welches Tier hat einen harten Panzer?", answers: ["Schildkröte", "Hund", "Vogel"], correct: 0, explanation: "Die Schildkröte trägt ihren Panzer als Schutz." },
    { category: "k1_sachunterricht", question: "Was zieht man im Winter über den Kopf?", answers: ["Mütze", "Sandalen", "T-Shirt"], correct: 0, explanation: "Im Winter ist eine Mütze warm und schützt die Ohren." },
    { category: "k1_sachunterricht", question: "Welche Farbe haben die Blätter im Sommer?", answers: ["Grün", "Gelb", "Rot"], correct: 0, explanation: "Im Sommer sind die Blätter an den Bäumen grün." },
    { category: "k1_sachunterricht", question: "Womit schreibt man in der Schule?", answers: ["Stift", "Gabel", "Kamm"], correct: 0, explanation: "Mit einem Stift oder Bleistift schreibt man." },
    { category: "k1_sachunterricht", question: "Wo schläft man nachts?", answers: ["Bett", "Küche", "Bad"], correct: 0, explanation: "Im Bett schläft man nachts." },
    ...
    { category: "k2_deutsch", question: "Welches Wort schreibt man groß?", answers: ["Hund", "rennt", "schnell"], correct: 0, explanation: "Hund ist ein Nomen und wird großgeschrieben." },
    { category: "k2_deutsch", question: "Was ist die Mehrzahl von 'Haus'?", answers: ["Häuser", "Hausen", "Häusern"], correct: 0, explanation: "Die Mehrzahl von Haus ist Häuser." },
    { category: "k2_deutsch", question: "Welche Schreibweise ist richtig: der Hund spielt?", answers: ["Der Hund spielt.", "der hund spielt.", "Der Hund spielt"], correct: 0, explanation: "Satzanfang groß, Nomen groß, Punkt am Ende." },
    { category: "k2_deutsch", question: "Was ist das Gegenteil von 'klein'?", answers: ["groß", "laut", "schnell"], correct: 0, explanation: "Klein und groß sind Gegenteile." },
    { category: "k2_deutsch", question: "Wie viele Silben hat 'Ap-fel'?", answers: ["2", "3", "1"], correct: 0, explanation: "Ap-fel – das sind zwei Silben." },
    ...
    { category: "k2_mathe", question: "Was ist 3 + 9?", answers: ["11", "12", "13"], correct: 1, explanation: "3 und 9 zusammengezählt sind 12." },
    { category: "k2_mathe", question: "Was ist 15 - 8?", answers: ["6", "7", "8"], correct: 1, explanation: "Von 15 acht weggenommen bleiben 7." },
    { category: "k2_mathe", question: "Wie viele Minuten hat eine halbe Stunde?", answers: ["30", "20", "60"], correct: 0, explanation: "Eine Stunde hat 60 Minuten, die Hälfte sind 30." },
    { category: "k2_mathe", question: "Was ist 5 × 0?", answers: ["0", "5", "10"], correct: 0, explanation: "Jede Zahl mal 0 ergibt 0." },
    { category: "k2_mathe", question: "Welche Zahl ist größer: 18 oder 14?", answers: ["18", "14", "Beide gleich"], correct: 0, explanation: "18 kommt später beim Zählen als 14, also ist 18 größer." },
    ...
    { category: "k2_sachunterricht", question: "Bei welcher Ampel darf man über die Straße gehen?", answers: ["Grün", "Rot", "Gelb"], correct: 0, explanation: "Bei Grün ist die Straße frei." },
    { category: "k2_sachunterricht", question: "Womit atmen Fische?", answers: ["Kiemen", "Lunge", "Haut"], correct: 0, explanation: "Fische nehmen mit den Kiemen Sauerstoff aus dem Wasser auf." },
    { category: "k2_sachunterricht", question: "Was ist ein Getreide?", answers: ["Weizen", "Tomate", "Kartoffel"], correct: 0, explanation: "Weizen ist eine Getreideart, aus dem Mehl gemacht wird." },
    { category: "k2_sachunterricht", question: "Welches Tier lebt auf dem Bauernhof und gibt Milch?", answers: ["Kuh", "Huhn", "Pferd"], correct: 0, explanation: "Kühe geben Milch, Hühner legen Eier." },
    ...
    { category: "k3_deutsch", question: "Was ist ein Nomen (Namenwort)?", answers: ["Baum", "rennen", "schön"], correct: 0, explanation: "Baum ist ein Nomen und wird großgeschrieben." },
    { category: "k3_deutsch", question: "Wie heißt die Vergangenheit von 'gehen'?", answers: ["ging", "geht", "ist gegangen"], correct: 0, explanation: "'Ging' ist das Präteritum von gehen." },
    { category: "k3_deutsch", question: "Welches der drei Wörter ist ein Verb?", answers: ["laufen", "schön", "Hund"], correct: 0, explanation: "Verben sind Tunwörter wie 'laufen'." },
    { category: "k3_deutsch", question: "Wie schreibt man die Mehrzahl von 'Baum'?", answers: ["Bäume", "Beume", "Beme"], correct: 0, explanation: "Bäume ist die korrekte Schreibweise." },
    { category: "k3_deutsch", question: "Was ist die Einzahl von 'Tische'?", answers: ["Tisch", "Tisches", "Tischen"], correct: 0, explanation: "Einzahl ist Tisch, Mehrzahl ist Tische." },
    ...
    { category: "k3_mathe", question: "Was ist 4 × 5?", answers: ["20", "25", "15"], correct: 0, explanation: "4 mal 5 ergibt 20." },
    { category: "k3_mathe", question: "Wie viele Zentimeter sind 2 m?", answers: ["200 cm", "20 cm", "2000 cm"], correct: 0, explanation: "1 m = 100 cm, also 2 m = 200 cm." },
    { category: "k3_mathe", question: "Wie viel ist 100 - 30?", answers: ["70", "80", "90"], correct: 0, explanation: "Von 100 dreißig weggenommen bleiben 70." },
    { category: "k3_mathe", question: "Wie viele Ecken hat ein Dreieck?", answers: ["3", "4", "5"], correct: 0, explanation: "Ein Dreieck hat genau 3 Ecken." },
    { category: "k3_mathe", question: "Was ist die Hälfte von 14?", answers: ["7", "8", "6"], correct: 0, explanation: "14 geteilt durch 2 ergibt 7." },
    ...
    { category: "k3_englisch", question: "Was heißt 'Katze' auf Englisch?", answers: ["cat", "dog", "bird"], correct: 0, explanation: "'Cat' ist die englische Übersetzung für Katze." },
    { category: "k3_englisch", question: "Wie heißt die Farbe 'rot' auf Englisch?", answers: ["red", "green", "blue"], correct: 0, explanation: "'Red' bedeutet rot." },
    { category: "k3_englisch", question: "Was bedeutet 'big'?", answers: ["groß", "klein", "alt"], correct: 0, explanation: "'Big' heißt groß." },
    { category: "k3_englisch", question: "Wie sagt man 'Hallo' auf Englisch?", answers: ["Hello", "Goodbye", "Good night"], correct: 0, explanation: "'Hello' heißt Hallo." },
    ...
    { category: "k3_tuerkisch", question: "Was heißt 'Hund' auf Türkisch?", answers: ["köpek", "kedi", "kuş"], correct: 0, explanation: "'Köpek' ist das türkische Wort für Hund." },
    { category: "k3_tuerkisch", question: "Was bedeutet 'iyi'?", answers: ["gut", "schlecht", "schön"], correct: 0, explanation: "'İyi' heißt gut." },
    { category: "k3_tuerkisch", question: "Wie heißt die Farbe 'rot' auf Türkisch?", answers: ["kırmızı", "mavi", "yeşil"], correct: 0, explanation: "'Kırmızı' bedeutet rot." },
    { category: "k3_tuerkisch", question: "Was bedeutet 'masa'?", answers: ["Tisch", "Stuhl", "Tür"], correct: 0, explanation: "'Masa' ist das türkische Wort für Tisch." },
    ...
    { category: "k4_deutsch", question: "Welcher Fall ist der Genitiv (2. Fall)?", answers: ["des Vaters", "dem Vater", "den Vater"], correct: 0, explanation: "Der Genitiv antwortet auf 'Wessen?' – hier: Wessen? Des Vaters." },
    { category: "k4_deutsch", question: "Was ist das Prädikat im Satz?", answers: ["Das Verb", "Das Subjekt", "Das Objekt"], correct: 0, explanation: "Das Prädikat ist das Verb oder der Verbteil im Satz." },
    { category: "k4_deutsch", question: "Kann ein Nebensatz alleine stehen?", answers: ["Kann nicht alleine stehen", "Kann alleine stehen", "Ist immer ein Fragesatz"], correct: 0, explanation: "Ein Nebensatz ist vom Hauptsatz abhängig." },
    { category: "k4_deutsch", question: "Welches Wort ist ein Adjektiv?", answers: ["schnell", "laufen", "Tisch"], correct: 0, explanation: "'Schnell' beschreibt eine Eigenschaft – es ist ein Adjektiv." },
    { category: "k4_deutsch", question: "Wie heißt 'ich bin gegangen' in der Zeit?", answers: ["Perfekt", "Präteritum", "Plusquamperfekt"], correct: 0, explanation: "Das Perfekt bildet man mit haben/sein + Partizip II." },
    ...
    { category: "k4_mathe", question: "Was ist 1/2 von 10?", answers: ["5", "4", "6"], correct: 0, explanation: "10 geteilt durch 2 ergibt 5." },
    { category: "k4_mathe", question: "Wie viele Ecken hat ein Würfel?", answers: ["8", "6", "12"], correct: 0, explanation: "Ein Würfel hat 8 Ecken und 12 Kanten." },
    { category: "k4_mathe", question: "Wie viel ist 25 + 37?", answers: ["62", "52", "72"], correct: 0, explanation: "25 + 37 = 62." },
    { category: "k4_mathe", question: "Wie viele Seiten hat ein Quadrat?", answers: ["4", "5", "3"], correct: 0, explanation: "Ein Quadrat hat 4 gleich lange Seiten." },
    { category: "k4_mathe", question: "Was ist größer: 0,5 oder 0,7?", answers: ["0,7", "0,5", "Beide gleich"], correct: 0, explanation: "0,7 ist größer als 0,5." },
    ...
    { category: "k4_sachunterricht", question: "Was ist ein Stromkreis?", answers: ["Ein geschlossener Weg für den Strom", "Ein Draht mit offenem Ende", "Ein Speicher für Strom"], correct: 0, explanation: "Nur in einem geschlossenen Stromkreis kann Strom fließen." },
    ...
    { category: "k4_englisch", question: "'I have a sister.' – Was heißt das?", answers: ["Ich habe eine Schwester", "Ich bin eine Schwester", "Ich habe einen Bruder"], correct: 0, explanation: "'I have' heißt 'ich habe'." },
    { category: "k4_englisch", question: "Was bedeutet 'never'?", answers: ["nie", "immer", "manchmal"], correct: 0, explanation: "'Never' heißt nie." },
    { category: "k4_englisch", question: "Wie fragt man nach dem Befinden?", answers: ["How are you?", "What is your name?", "Where is it?"], correct: 0, explanation: "'How are you?' fragt nach dem Befinden." },
    { category: "k4_englisch", question: "Was bedeutet 'schoolbag'?", answers: ["Schulranzen", "Stift", "Buch"], correct: 0, explanation: "'Schoolbag' ist der Schulranzen." },
    ...
    { category: "k4_tuerkisch", question: "Was heißt 'Tisch' auf Türkisch?", answers: ["masa", "sandalye", "kapı"], correct: 0, explanation: "'Masa' heißt Tisch." },
    { category: "k4_tuerkisch", question: "Wie heißt 'Schule' auf Türkisch?", answers: ["okul", "ev", "iş"], correct: 0, explanation: "'Okul' ist das türkische Wort für Schule." },
    ...
    { category: "k5_deutsch", question: "Was ist eine Inhaltsangabe?", answers: ["Sachliche Zusammenfassung im Präsens", "Eine ausführliche eigene Meinung", "Eine Sammlung wörtlicher Zitate"], correct: 0, explanation: "Inhaltsangaben fassen sachlich, im Präsens und in eigenen Worten zusammen." },
    ...
    { category: "k5_deutsch", question: "Was ist ein Märchen typischerweise?", answers: ["Eine erfundene Erzählung mit Zauber", "Ein Sachtext mit belegten Fakten", "Ein Zeitungsbericht über ein Ereignis"], correct: 0, explanation: "Märchen sind erfundene Erzählungen, oft mit magischen Elementen." },
    ...
    { category: "k5_mathe", question: "Was ist eine Primzahl?", answers: ["Nur durch 1 und sich selbst teilbar", "Jede gerade Zahl über der Zwei", "Jede ungerade Zahl über der Eins"], correct: 0, explanation: "Primzahlen wie 2, 3, 5, 7 haben genau zwei Teiler." },
    ...
    // --- Klasse 5 - Biologie ---
    { category: "k5_biologie", question: "Was brauchen Pflanzen für die Fotosynthese?", answers: ["Sonnenlicht, Wasser und CO2", "Ausschließlich sehr viel Wasser", "Ausschließlich guten Dünger"], correct: 0, explanation: "Aus Licht, Wasser und Kohlendioxid entsteht Traubenzucker und Sauerstoff." },
    ...
    { category: "k5_biologie", question: "Wozu dienen die Wurzeln einer Pflanze?", answers: ["Aufnahme von Wasser und Nährstoffen", "Sie dienen allein der Zierde", "Dort läuft die Fotosynthese ab"], correct: 0, explanation: "Wurzeln verankern die Pflanze und nehmen Wasser auf." },
    ...
    { category: "k5_politik", question: "Was ist eine Gemeinde?", answers: ["Die kleinste politische Einheit vor Ort", "Ein Bundesland mit eigener Regierung", "Ein Staat mit eigener Verfassung"], correct: 0, explanation: "Städte und Dörfer sind Gemeinden mit eigener Verwaltung." },
    ...
    { category: "k6_deutsch", question: "Was ist ein Attribut?", answers: ["Ein Wort, das ein Satzglied beschreibt", "Ein eigenständiger vollständiger Satz", "Ein Satzzeichen am Ende des Satzes"], correct: 0, explanation: "Beispiel: 'der GROSSE Hund' – 'große' ist ein Attribut." },
    { category: "k6_deutsch", question: "Was ist der Unterschied zwischen 'wie' und 'als' beim Vergleich?", answers: ["'wie' bei Gleichheit, 'als' bei Ungleichheit", "Beide Wörter bedeuten dasselbe", "Genau umgekehrt zur ersten Antwort"], correct: 0, explanation: "So groß WIE (gleich), größer ALS (ungleich)." },
    { category: "k6_deutsch", question: "Was kennzeichnet einen Bericht?", answers: ["Sachlich, im Präteritum, W-Fragen geklärt", "Spannend erzählt und ausgeschmückt", "Frei erfunden und in der Ich-Form"], correct: 0, explanation: "Ein Bericht antwortet sachlich auf Wer, Was, Wann, Wo, Wie, Warum." },
    ...
    { category: "k6_biologie", question: "Was ist eine Nahrungskette?", answers: ["Eine Reihenfolge, wer wen frisst", "Eine Anleitung zum Zubereiten", "Ein Organ für die Verdauung"], correct: 0, explanation: "Sie zeigt, wie Energie von Pflanzen über Tiere weitergegeben wird." },
    ...
    { category: "k6_physik", question: "Was ist ein geschlossener Stromkreis?", answers: ["Ein durchgehender Weg für den Strom", "Eine Batterie ganz ohne Anschluss", "Ein Schalter ganz ohne Leitung"], correct: 0, explanation: "Erst im geschlossenen Kreis fließt Strom." },
    ...
    // --- Klasse 6 - Geschichte ---
    { category: "k6_geschichte", question: "Wer war Alexander der Große?", answers: ["Ein makedonischer König und Feldherr", "Ein römischer Kaiser der Antike", "Ein ägyptischer Pharao am Nil"], correct: 0, explanation: "Er eroberte eines der größten Reiche der Antike." },
    ...
    { category: "k6_geschichte", question: "Wie nennt man die Zeit vor der Schrift?", answers: ["Vorgeschichte oder Urgeschichte", "Neuzeit ab etwa 1500", "Mittelalter nach der Antike"], correct: 0, explanation: "Ohne schriftliche Quellen spricht man von Vor- oder Urgeschichte." },
    ...
    { category: "k6_erdkunde", question: "Was versteht man unter Urbanisierung?", answers: ["Wachstum der Städte durch Zuzug", "Rückzug der Menschen aufs Land", "Ausbau von Straßen und Schienen"], correct: 0, explanation: "Immer mehr Menschen ziehen in Städte." },
    ...
    { category: "k7_deutsch", question: "Was ist der Konjunktiv?", answers: ["Die Möglichkeits- und Wunschform", "Eine Zeitform der Vergangenheit", "Ein Satzzeichen für Wünsche"], correct: 0, explanation: "Der Konjunktiv drückt Wünsche, Möglichkeiten oder indirekte Rede aus." },
    ...
    { category: "k7_deutsch", question: "Was ist typisch für eine Charakterisierung?", answers: ["Aussehen, Verhalten und Denken beschreiben", "Die Handlung Schritt für Schritt nacherzählen", "Die eigene Meinung zur Figur aufschreiben"], correct: 0, explanation: "Eine Charakterisierung beschreibt äußere und innere Merkmale einer Figur." },
    ...
    { category: "k7_biologie", question: "Was unterscheidet Pflanzenzellen von Tierzellen?", answers: ["Zellwand und Chloroplasten", "Deutlich mehr Zellkerne", "Es gibt keinen Unterschied"], correct: 0, explanation: "Pflanzenzellen haben zusätzlich eine feste Zellwand und Chloroplasten." },
    ...
    { category: "k7_physik", question: "Was besagt das Trägheitsgesetz?", answers: ["Ohne Kraft bleibt die Bewegung gleich", "Kraft ist Masse mal Beschleunigung", "Jede Kraft hat eine Gegenkraft"], correct: 0, explanation: "Das ist das erste Newtonsche Gesetz." },
    ...
    // --- Klasse 7 - Geschichte ---
    { category: "k7_geschichte", question: "Was war die Reformation?", answers: ["Eine Kirchenerneuerung ab 1517", "Ein großer Krieg im Altertum", "Eine technische Erfindung"], correct: 0, explanation: "Aus ihr ging die evangelische Kirche hervor." },
    ...
    { category: "k7_geschichte", question: "Was bedeutet 'Renaissance'?", answers: ["Wiedergeburt der Antike", "Neuzeit ab etwa 1500", "Aufklärung im 18. Jahrhundert"], correct: 0, explanation: "Die Renaissance knüpfte an antike Vorbilder an." },

    // --- Klasse 7 - Erdkunde ---
    { category: "k7_erdkunde", question: "Was ist eine Wüste?", answers: ["Ein sehr trockenes Gebiet mit wenig Regen", "Ein Gebiet mit sehr hohen Niederschlägen", "Ein dicht bewachsenes Waldgebiet"], correct: 0, explanation: "Wüsten erhalten meist unter 250 mm Niederschlag pro Jahr." },
    ...
    { category: "k7_erdkunde", question: "Was ist ein Passatwind?", answers: ["Ein beständiger Wind in den Tropen", "Ein plötzlicher Sturm über Europa", "Ein eiskalter Wind aus der Polarzone"], correct: 0, explanation: "Passate wehen regelmäßig Richtung Äquator." },
    ...
    { category: "k7_erdkunde", question: "Was versteht man unter Tourismus?", answers: ["Reisen aus Freizeit- oder Erholungsgründen", "Handel mit Waren über Ländergrenzen", "Anbau von Nutzpflanzen auf Feldern"], correct: 0, explanation: "Tourismus ist ein wichtiger Wirtschaftszweig vieler Regionen." },

    // --- Klasse 7 - Politik & Wirtschaft ---
    { category: "k7_politik", question: "Was bedeutet Gewaltenteilung?", answers: ["Trennung von Gesetzgebung, Regierung, Gerichten", "Aufteilung des Militärs auf mehrere Standorte", "Verteilung der Steuern auf die Bundesländer"], correct: 0, explanation: "Legislative, Exekutive und Judikative kontrollieren sich gegenseitig." },
    ...
    // --- Klasse 8 - Deutsch ---
    { category: "k8_deutsch", question: "Was ist das Ziel einer Erörterung?", answers: ["Pro- und Contra-Argumente abwägen", "Eine Geschichte spannend nacherzählen", "Gedichte nach Reimschema verfassen"], correct: 0, explanation: "Man wägt Argumente ab und kommt zu einem begründeten Fazit." },
    ...
    { category: "k8_deutsch", question: "Was ist die indirekte Rede?", answers: ["Wiedergabe von Gesagtem im Konjunktiv", "Ein wörtliches Zitat mit Anführungszeichen", "Eine direkte Frage an den Gesprächspartner"], correct: 0, explanation: "Beispiel: 'Er sagte, er komme später.'" },
    ...
    { category: "k8_deutsch", question: "Was ist ein Nebensatz?", answers: ["Ein Satz, der allein nicht stehen kann", "Der tragende Hauptteil eines Satzes", "Ein Satzzeichen zwischen zwei Sätzen"], correct: 0, explanation: "Nebensätze werden durch Konjunktionen eingeleitet und mit Komma abgetrennt." },
    ...
    { category: "k8_biologie", question: "Was ist ein dominantes Allel?", answers: ["Es setzt sich gegenüber dem rezessiven durch", "Es handelt sich um ein fehlerhaftes Gen", "Es bleibt in jedem Fall völlig wirkungslos"], correct: 0, explanation: "Das rezessive Merkmal zeigt sich nur bei zwei rezessiven Allelen." },
    ...
    { category: "k8_chemie", question: "Was ist ein Katalysator?", answers: ["Er beschleunigt eine Reaktion, ohne sich zu verbrauchen", "Er entsteht als Endprodukt der chemischen Reaktion", "Er misst die Temperatur während der Reaktion"], correct: 0, explanation: "Er senkt die nötige Aktivierungsenergie." },
    ...
    { category: "k8_physik", question: "Was passiert mit dem Gesamtwiderstand in einer Reihenschaltung?", answers: ["Die Widerstände addieren sich", "Er wird kleiner als der kleinste", "Er bleibt unverändert gleich"], correct: 0, explanation: "R gesamt = R1 + R2 + ..." },
    ...
    { category: "k8_geschichte", question: "Was war die Industrielle Revolution?", answers: ["Der Übergang zur maschinellen Produktion", "Ein langer Krieg zwischen Königreichen", "Eine Erneuerung der kirchlichen Lehre"], correct: 0, explanation: "Sie begann Ende des 18. Jahrhunderts in England." },
    { category: "k8_geschichte", question: "Wofür stehen die Ideale der Französischen Revolution?", answers: ["Freiheit, Gleichheit, Brüderlichkeit", "Ordnung, Fleiß und Gehorsam", "Glaube, Liebe und Hoffnung"], correct: 0, explanation: "'Liberté, égalité, fraternité'." },
    { category: "k8_geschichte", question: "Wer war Otto von Bismarck?", answers: ["Der erste Reichskanzler Deutschlands", "Ein bekannter Komponist der Romantik", "Ein Erfinder der Dampfmaschine"], correct: 0, explanation: "Er war maßgeblich an der Reichsgründung 1871 beteiligt." },
    { category: "k8_geschichte", question: "Was war die Aufklärung?", answers: ["Eine Geistesbewegung, die Vernunft betonte", "Eine militärische Taktik im Stellungskrieg", "Eine Kunstrichtung mit religiösen Motiven"], correct: 0, explanation: "Kant fasste sie als Ausgang aus selbstverschuldeter Unmündigkeit." },

    // --- Klasse 8 - Erdkunde ---
    { category: "k8_erdkunde", question: "Was versteht man unter dem Treibhauseffekt?", answers: ["Rückhalt von Wärme in der Atmosphäre", "Eine allmähliche Abkühlung der Erde", "Ein besonders starker Vulkanausbruch"], correct: 0, explanation: "Treibhausgase wie CO2 halten Wärme zurück." },
    { category: "k8_erdkunde", question: "Was ist Erosion?", answers: ["Abtragung von Boden durch Wasser oder Wind", "Auffaltung von Gebirgen durch Plattendruck", "Plötzliche Erschütterung des Untergrunds"], correct: 0, explanation: "Wind und Wasser tragen Material ab." },
    { category: "k8_erdkunde", question: "Was sind erneuerbare Energien?", answers: ["Energie aus Sonne, Wind und Wasser", "Energie aus Kohle und Erdöl", "Energie aus Erdgas und Torf"], correct: 0, explanation: "Sie stehen dauerhaft zur Verfügung." },
    { category: "k8_erdkunde", question: "Was bedeutet Migration?", answers: ["Wanderung von Menschen über Grenzen", "Austausch von Waren zwischen Staaten", "Langfristige Veränderung des Klimas"], correct: 0, explanation: "Menschen verlassen dauerhaft ihren Wohnort." },
    { category: "k8_erdkunde", question: "Was ist eine Megastadt?", answers: ["Eine Stadt mit über 10 Millionen Menschen", "Die Hauptstadt eines größeren Landes", "Eine Stadt mit vielen großen Fabriken"], correct: 0, explanation: "Beispiele sind Tokio, Delhi oder Shanghai." },
    ...
    { category: "k8_politik", question: "Was ist der Unterschied zwischen Monarchie und Republik?", answers: ["In der Republik wird das Staatsoberhaupt gewählt", "Zwischen beiden gibt es keinen echten Unterschied", "Republiken kommen ganz ohne Regierung aus"], correct: 0, explanation: "In Monarchien wird die Macht meist vererbt." },
    ...
    { category: "k8_politik", question: "Was macht eine Gewerkschaft?", answers: ["Sie vertritt die Interessen der Arbeitnehmer", "Sie vertritt die Interessen der Arbeitgeber", "Sie beschließt neue Gesetze im Parlament"], correct: 0, explanation: "Gewerkschaften verhandeln z.B. über Löhne." },
    ...
    { category: "k8_informatik", question: "Was ist ein Algorithmus?", answers: ["Eine eindeutige Schritt-für-Schritt-Anleitung", "Ein Schadprogramm auf dem Computer", "Eine bestimmte Programmiersprache"], correct: 0, explanation: "Ein Algorithmus löst ein Problem in endlich vielen Schritten." },
    ...
    { category: "k8_informatik", question: "Was ist 'Phishing'?", answers: ["Betrug, um an Zugangsdaten zu kommen", "Ein bekanntes Computerspiel im Netz", "Eine geplante Sicherung von Daten"], correct: 0, explanation: "Betrüger täuschen echte Nachrichten vor." },
    ...
    // --- Klasse 9 - Deutsch ---
    { category: "k9_deutsch", question: "Was ist eine These?", answers: ["Eine Behauptung, die begründet wird", "Ein Beispiel zur Veranschaulichung", "Die Zusammenfassung am Textende"], correct: 0, explanation: "Die These ist der Kern einer Argumentation." },
    { category: "k9_deutsch", question: "Was ist ein Symbol in der Literatur?", answers: ["Ein Zeichen mit tieferer Bedeutung", "Ein Satzzeichen zur Gliederung", "Eine Überschrift über dem Kapitel"], correct: 0, explanation: "Beispiel: die Taube als Symbol für Frieden." },
    ...
    { category: "k9_deutsch", question: "Was ist eine Personifikation?", answers: ["Etwas Unbelebtes handelt wie ein Mensch", "Eine bewusst starke Übertreibung", "Ein Vergleich mit 'wie' oder 'als'"], correct: 0, explanation: "Beispiel: 'Die Sonne lacht'." },
    ...
    { category: "k9_mathe", question: "Was ist eine lineare Funktion?", answers: ["y = m·x + b, der Graph ist eine Gerade", "y = x², der Graph ist eine Parabel", "Der Graph ist ein geschlossener Kreis"], correct: 0, explanation: "m ist die Steigung, b der y-Achsenabschnitt." },
    ...
    { category: "k9_biologie", question: "Was ist ein Ökosystem?", answers: ["Lebewesen und ihre Umwelt im Zusammenspiel", "Ausschließlich die Tiere eines Gebiets", "Ein künstlich angelegter Ziergarten"], correct: 0, explanation: "Belebte und unbelebte Faktoren wirken zusammen." },
    { category: "k9_biologie", question: "Was bewirkt eine Impfung?", answers: ["Das Immunsystem lernt den Erreger kennen", "Sie tötet sämtliche Bakterien im Körper", "Sie ersetzt fehlendes Blut im Kreislauf"], correct: 0, explanation: "Der Körper bildet Antikörper und Gedächtniszellen." },
    { category: "k9_biologie", question: "Was ist Meiose?", answers: ["Reifeteilung mit halbem Chromosomensatz", "Normale Teilung einer Körperzelle", "Ein Botenstoff für das Wachstum"], correct: 0, explanation: "Bei der Meiose entstehen Keimzellen." },
    ...
    { category: "k9_chemie", question: "Was ist ein Redoxvorgang?", answers: ["Elektronenübertragung: Oxidation und Reduktion", "Eine reine Verbrennung unter Wärmeabgabe", "Eine Trennung von Stoffen durch Filtern"], correct: 0, explanation: "Ein Stoff gibt Elektronen ab, ein anderer nimmt sie auf." },
    { category: "k9_chemie", question: "Was ist eine Legierung?", answers: ["Ein Gemisch aus mehreren Metallen", "Eine stark ätzende Säure", "Ein farbloses, leichtes Gas"], correct: 0, explanation: "Beispiel: Messing aus Kupfer und Zink." },
    ...
    { category: "k9_physik", question: "Wie funktioniert ein Generator?", answers: ["Bewegung erzeugt elektrische Spannung", "Strom erzeugt eine drehende Bewegung", "Er speichert Strom für später"], correct: 0, explanation: "Er nutzt elektromagnetische Induktion." },
    ...
    { category: "k9_geschichte", question: "Was war die Weimarer Republik?", answers: ["Deutschlands erste Demokratie 1919-1933", "Ein Königreich im 19. Jahrhundert", "Die heutige Bundesrepublik Deutschland"], correct: 0, explanation: "Sie entstand nach dem Ersten Weltkrieg." },
    ...
    { category: "k9_geschichte", question: "Was war der Holocaust?", answers: ["Der Völkermord an den europäischen Juden", "Eine entscheidende Schlacht im Krieg", "Ein Friedensvertrag nach dem Krieg"], correct: 0, explanation: "Millionen Menschen wurden systematisch ermordet." },
    { category: "k9_geschichte", question: "Was war der Kalte Krieg?", answers: ["Der Ost-West-Konflikt nach 1945", "Ein Feldzug während des Winters", "Ein Bürgerkrieg innerhalb eines Staates"], correct: 0, explanation: "Systemkonflikt zwischen USA und Sowjetunion ohne direkten Krieg." },

    // --- Klasse 9 - Erdkunde ---
    { category: "k9_erdkunde", question: "Was bedeutet Globalisierung?", answers: ["Weltweite Verflechtung von Wirtschaft und Kultur", "Bewusster Rückzug auf das eigene Staatsgebiet", "Ausschließlich der Reiseverkehr zwischen Ländern"], correct: 0, explanation: "Waren, Kapital und Informationen bewegen sich weltweit." },
    { category: "k9_erdkunde", question: "Was ist Nachhaltigkeit?", answers: ["So wirtschaften, dass künftige Generationen leben können", "So wirtschaften, dass der Gewinn möglichst schnell wächst", "So wirtschaften, dass möglichst wenig ausgegeben wird"], correct: 0, explanation: "Ökologie, Ökonomie und Soziales im Gleichgewicht." },
    { category: "k9_erdkunde", question: "Was ist ein Entwicklungsland?", answers: ["Land mit geringerem wirtschaftlichem Entwicklungsstand", "Ein Land ganz ohne funktionierende Regierung", "Ein Land mit besonders kleiner Landesfläche"], correct: 0, explanation: "Kennzeichen sind z.B. niedriges Pro-Kopf-Einkommen." },
    ...
    { category: "k9_politik", question: "Was ist die soziale Marktwirtschaft?", answers: ["Freie Marktwirtschaft mit sozialem Ausgleich", "Vom Staat vollständig geplante Wirtschaft", "Wirtschaft ohne jede staatliche Regel"], correct: 0, explanation: "Der Staat sorgt für sozialen Ausgleich und Wettbewerb." },
    ...
    { category: "k9_politik", question: "Was ist die EU?", answers: ["Ein Staatenverbund europäischer Länder", "Ein einzelner Staat mit einer Regierung", "Ein großes europäisches Unternehmen"], correct: 0, explanation: "Die Europäische Union hat gemeinsame Institutionen und Regeln." },
    { category: "k9_politik", question: "Was sind Steuern?", answers: ["Abgaben an den Staat ohne Gegenleistung", "Freiwillige Spenden an gemeinnützige Vereine", "Gebühren für die Führung eines Bankkontos"], correct: 0, explanation: "Sie finanzieren staatliche Aufgaben." },
    ...
    { category: "k9_informatik", question: "Was ist eine Variable?", answers: ["Ein Speicherplatz für veränderbare Werte", "Ein fest im Code stehender Textbaustein", "Ein Fehler im Ablauf eines Programms"], correct: 0, explanation: "Der Inhalt kann sich während des Programms ändern." },
    ...
    { category: "k10_deutsch", question: "Was ist der Unterschied zwischen Epik, Lyrik und Dramatik?", answers: ["Erzählende, gedichtartige und dramatische Texte", "Alte, neuere und ganz moderne Texte", "Kurze, mittellange und sehr lange Texte"], correct: 0, explanation: "Das sind die drei literarischen Gattungen." },
    { category: "k10_deutsch", question: "Was ist Sprachkritik?", answers: ["Das bewusste Hinterfragen von Sprachgebrauch", "Das Korrigieren von Rechtschreibfehlern", "Das betonte Vorlesen eines Textes"], correct: 0, explanation: "Zum Beispiel Analyse von Werbe- oder Politikersprache." },
    ...
    { category: "k10_deutsch", question: "Was ist ein Exposé?", answers: ["Eine kurze Vorstellung eines Vorhabens", "Ein zusammenfassendes Schlusswort", "Eine erklärende Anmerkung am Seitenende"], correct: 0, explanation: "Es fasst Thema, Ziel und Vorgehen zusammen." },

    // --- Klasse 10 - Mathematik ---
    { category: "k10_mathe", question: "Wie lautet die Mitternachtsformel für ax² + bx + c = 0?", answers: ["x = (-b ± √(b²-4ac)) / 2a", "x = -b geteilt durch 2a", "x = b² minus 4ac"], correct: 0, explanation: "Damit löst man quadratische Gleichungen." },
    ...
    { category: "k10_mathe", question: "Was ist der Kosinussatz nützlich für?", answers: ["Dreiecke ohne rechten Winkel berechnen", "Ausschließlich rechtwinklige Dreiecke", "Umfang und Fläche von Kreisen"], correct: 0, explanation: "c² = a² + b² - 2ab·cos(γ)." },
    { category: "k10_mathe", question: "Was ist exponentielles Wachstum?", answers: ["Wachstum mit gleichbleibendem Faktor", "Wachstum um immer denselben Betrag", "Stetige Abnahme um einen Betrag"], correct: 0, explanation: "Beispiel: Verdopplung in jedem Zeitschritt." },
    ...
    // --- Klasse 10 - Biologie ---
    { category: "k10_biologie", question: "Was ist die DNA?", answers: ["Träger der Erbinformation", "Ein Eiweiß im Blutkreislauf", "Ein Botenstoff der Drüsen"], correct: 0, explanation: "Sie hat die Form einer Doppelhelix." },
    { category: "k10_biologie", question: "Was sind Hormone?", answers: ["Botenstoffe, die Vorgänge im Körper steuern", "Blutzellen für den Sauerstofftransport", "Enzyme für die Verdauung im Darm"], correct: 0, explanation: "Beispiel: Insulin regelt den Blutzucker." },
    ...
    // --- Klasse 10 - Chemie ---
    { category: "k10_chemie", question: "Was ist eine funktionelle Gruppe?", answers: ["Atomgruppe, die die Eigenschaften bestimmt", "Eine einzelne Atomsorte im Molekül", "Ein Stoff, der Reaktionen beschleunigt"], correct: 0, explanation: "Beispiel: die OH-Gruppe bei Alkoholen." },
    ...
    { category: "k10_chemie", question: "Was passiert bei einer Elektrolyse?", answers: ["Strom erzwingt eine chemische Reaktion", "Wärme erzeugt elektrischen Strom", "Ein Stoffgemisch wird gefiltert"], correct: 0, explanation: "Beispiel: Zerlegung von Wasser in Wasserstoff und Sauerstoff." },

    // --- Klasse 10 - Physik ---
    { category: "k10_physik", question: "Was ist Induktion?", answers: ["Spannungserzeugung durch Magnetfeldänderung", "Erwärmung von Stoffen durch starke Reibung", "Ablenkung von Licht beim Übergang ins Wasser"], correct: 0, explanation: "Grundlage von Generatoren und Transformatoren." },
    { category: "k10_physik", question: "Wozu dient ein Transformator?", answers: ["Wechselspannung hoch- oder heruntersetzen", "Gleichstrom über längere Zeit speichern", "Die Stromstärke im Netz messen"], correct: 0, explanation: "Er nutzt zwei Spulen und Induktion." },
    { category: "k10_physik", question: "Was beschreibt E = m·c²?", answers: ["Die Äquivalenz von Masse und Energie", "Die Geschwindigkeit beim freien Fall", "Den Widerstand der Luft beim Fliegen"], correct: 0, explanation: "Einsteins berühmte Formel." },
    { category: "k10_physik", question: "Was ist der Unterschied zwischen Gleich- und Wechselstrom?", answers: ["Wechselstrom ändert regelmäßig die Richtung", "Gleichstrom ist grundsätzlich der stärkere", "Zwischen beiden besteht kein Unterschied"], correct: 0, explanation: "Aus der Steckdose kommt Wechselstrom." },
    ...
    { category: "k10_geschichte", question: "Was war die deutsche Wiedervereinigung?", answers: ["Der Zusammenschluss von BRD und DDR 1990", "Die Gründung des Deutschen Reiches 1871", "Der Beitritt Deutschlands zur EU"], correct: 0, explanation: "Am 3. Oktober 1990 wurde Deutschland wiedervereinigt." },
    ...
    // --- Klasse 10 - Erdkunde ---
    { category: "k10_erdkunde", question: "Was ist der Strukturwandel?", answers: ["Verschiebung von Industrie zu Dienstleistung", "Der Bau neuer Straßen und Schienenwege", "Das Wachstum der Bevölkerungszahl"], correct: 0, explanation: "Beispiel: das Ruhrgebiet nach dem Bergbau." },
    { category: "k10_erdkunde", question: "Was ist Raumordnung?", answers: ["Planung der Nutzung von Flächen", "Planung der Einrichtung von Räumen", "Beobachtung und Vorhersage des Wetters"], correct: 0, explanation: "Sie steuert Siedlung, Verkehr und Naturschutz." },
    { category: "k10_erdkunde", question: "Was ist der demografische Wandel?", answers: ["Veränderung des Altersaufbaus der Bevölkerung", "Langfristige Veränderung von Wetter und Klima", "Regelmäßige Wanderung von Tieren über Grenzen"], correct: 0, explanation: "In Deutschland altert die Bevölkerung." },
    { category: "k10_erdkunde", question: "Was ist eine Disparität?", answers: ["Ungleichheit zwischen Regionen", "Ein plötzliches Naturereignis", "Eine wichtige Handelsroute"], correct: 0, explanation: "Zum Beispiel Unterschiede in Einkommen oder Infrastruktur." },
    { category: "k10_erdkunde", question: "Was ist Landwirtschaft im Gunstraum?", answers: ["Anbau unter günstigen natürlichen Bedingungen", "Anbau unter künstlicher Bewässerung in der Wüste", "Anbau in beheizten und beleuchteten Gewächshäusern"], correct: 0, explanation: "Gunsträume haben gutes Klima und fruchtbare Böden." },

    // --- Klasse 10 - Politik & Wirtschaft ---
    { category: "k10_politik", question: "Was ist das Subsidiaritätsprinzip?", answers: ["Aufgaben werden möglichst kleinräumig gelöst", "Der Staat regelt grundsätzlich alle Aufgaben", "Alle Entscheidungen trifft allein die EU"], correct: 0, explanation: "Höhere Ebenen greifen nur ein, wenn nötig." },
    { category: "k10_politik", question: "Was macht das Bundesverfassungsgericht?", answers: ["Es prüft Gesetze am Grundgesetz", "Es beschließt neue Gesetze", "Es wählt den Bundeskanzler"], correct: 0, explanation: "Es ist das höchste deutsche Gericht." },
    { category: "k10_politik", question: "Was ist ein Betriebsrat?", answers: ["Vertretung der Beschäftigten im Betrieb", "Die Geschäftsführung eines Unternehmens", "Eine staatliche Aufsichtsbehörde"], correct: 0, explanation: "Er hat Mitbestimmungsrechte." },
    { category: "k10_politik", question: "Was bedeutet Konjunktur?", answers: ["Der wirtschaftliche Auf- und Abschwung", "Der Haushaltsplan des gesamten Staates", "Der Wechselkurs zwischen zwei Währungen"], correct: 0, explanation: "Man spricht von Konjunkturzyklen." },
    { category: "k10_politik", question: "Was ist Föderalismus?", answers: ["Aufteilung der Macht zwischen Bund und Ländern", "Herrschaft einer einzelnen Person über den Staat", "Abstimmung des Volkes über jede Sachfrage"], correct: 0, explanation: "Deutschland ist ein föderaler Bundesstaat." },

    // --- Klasse 10 - Informatik & Medien ---
    { category: "k10_informatik", question: "Was ist eine Bedingung (if-Abfrage)?", answers: ["Code läuft nur, wenn etwas zutrifft", "Code läuft in jedem Fall immer ab", "Ein Fehler beim Ausführen des Codes"], correct: 0, explanation: "Damit trifft ein Programm Entscheidungen." },
    { category: "k10_informatik", question: "Was ist eine Datenbank?", answers: ["System zum strukturierten Speichern von Daten", "Programm zum Schreiben und Setzen von Texten", "Dateiformat zum Speichern von Fotos"], correct: 0, explanation: "Beispiele sind MySQL oder SQLite." },
    { category: "k10_informatik", question: "Was ist ein Betriebssystem?", answers: ["Software, die die Hardware steuert", "Ein Bauteil im Inneren des Rechners", "Ein Dienst zum Surfen im Internet"], correct: 0, explanation: "Windows, macOS, Linux, Android." },
    ...
    // --- Klasse 11 - Deutsch ---
    { category: "k11_deutsch", question: "Was kennzeichnet die Epoche der Aufklärung in der Literatur?", answers: ["Vernunft und Kritik an Autoritäten", "Das Gefühl steht über allem", "Rückzug in die unberührte Natur"], correct: 0, explanation: "Lessings 'Nathan der Weise' ist ein typisches Werk." },
    ...
    { category: "k11_deutsch", question: "Was ist eine Sprachvarietät?", answers: ["Eine Ausprägung wie Dialekt oder Fachsprache", "Ein wiederkehrender Rechtschreibfehler", "Eine bestimmte grammatische Zeitform"], correct: 0, explanation: "Dazu zählen Dialekt, Soziolekt und Fachsprache." },
    { category: "k11_deutsch", question: "Was untersucht die Rhetorik?", answers: ["Die Kunst der wirkungsvollen Rede", "Die Regeln der richtigen Schreibung", "Den Bau von Sätzen und Wortformen"], correct: 0, explanation: "Sie analysiert Aufbau, Stilmittel und Wirkung von Reden." },
    ...
    { category: "k11_mathe", question: "Was beschreibt der Grenzwert einer Funktion?", answers: ["Das Verhalten bei Annäherung an einen Wert", "Den größten erreichbaren Funktionswert", "Die Stelle, an der der Graph null wird"], correct: 0, explanation: "Grundlage der Differenzialrechnung." },
    ...
    // --- Klasse 11 - Englisch ---
    { category: "k11_englisch", question: "Was ist 'mediation' im Englischunterricht?", answers: ["Sinngemäßes Übertragen zwischen Sprachen", "Wort-für-Wort-Übersetzung eines Textes", "Eine geführte Diskussion in der Klasse"], correct: 0, explanation: "Man gibt Inhalte adressatengerecht in der anderen Sprache wieder." },
    ...
    { category: "k11_englisch", question: "Was ist ein 'topic sentence'?", answers: ["Der Kernsatz eines Absatzes", "Die Überschrift über dem Text", "Der letzte Satz eines Absatzes"], correct: 0, explanation: "Er nennt die Hauptaussage des Absatzes." },
    ...
    // --- Klasse 11 - Biologie ---
    { category: "k11_biologie", question: "Was ist die Funktion der Zellmembran?", answers: ["Sie regelt den Stoffaustausch der Zelle", "Sie speichert die gesamte Erbinformation", "Sie erzeugt die Energie für die Zelle"], correct: 0, explanation: "Sie ist selektiv permeabel." },
    { category: "k11_biologie", question: "Was ist Enzymspezifität?", answers: ["Ein Enzym passt nur zu bestimmten Substraten", "Ein Enzym wirkt bei allen Stoffen gleich gut", "Ein Enzym wird bei der Reaktion aufgebraucht"], correct: 0, explanation: "Schlüssel-Schloss-Prinzip." },
    { category: "k11_biologie", question: "Was passiert bei der Zellatmung?", answers: ["Glucose wird unter Sauerstoff abgebaut", "Zucker wird aus einfachen Stoffen aufgebaut", "Wasser wird in seine Bestandteile gespalten"], correct: 0, explanation: "Sie liefert ATP für die Zelle." },
    ...
    { category: "k11_chemie", question: "Was ist die Aktivierungsenergie?", answers: ["Die Energie, die eine Reaktion zum Start braucht", "Die Energie, die bei der Reaktion frei wird", "Die gesamte im Stoff gespeicherte Energie"], correct: 0, explanation: "Katalysatoren senken sie." },
    ...
    // --- Klasse 11 - Physik ---
    { category: "k11_physik", question: "Was ist eine gleichförmige Bewegung?", answers: ["Konstante Geschwindigkeit ohne Beschleunigung", "Stetig zunehmende Geschwindigkeit über die Zeit", "Vollständiger Stillstand ohne jede Bewegung"], correct: 0, explanation: "Der Weg-Zeit-Graph ist eine Gerade." },
    { category: "k11_physik", question: "Was ist der freie Fall?", answers: ["Bewegung nur unter Schwerkraft", "Bewegung mit eigenem Antrieb", "Bewegung auf einer Kreisbahn"], correct: 0, explanation: "Auf der Erde etwa 9,81 m/s²." },
    ...
    { category: "k11_geschichte", question: "Was war der Absolutismus?", answers: ["Herrschaftsform mit unbeschränkter Macht", "Demokratie mit gewähltem Parlament", "Republik mit begrenzter Amtszeit"], correct: 0, explanation: "Ludwig XIV. gilt als Musterbeispiel." },
    { category: "k11_geschichte", question: "Was ist eine historische Quelle?", answers: ["Ein Überrest oder Bericht aus der Vergangenheit", "Ein moderner Fachtext über ein Ereignis", "Eine persönliche Meinung zu einem Thema"], correct: 0, explanation: "Man unterscheidet Primär- und Sekundärquellen." },
    ...
    { category: "k11_geschichte", question: "Was bedeutet Historizität?", answers: ["Die Gebundenheit an eine bestimmte Zeit", "Die zeitlose Gültigkeit einer Aussage", "Die genaue Datierung eines Ereignisses"], correct: 0, explanation: "Ereignisse müssen aus ihrer Zeit heraus verstanden werden." },
    ...
    { category: "k11_sowi", question: "Was ist eine Rolle im soziologischen Sinn?", answers: ["Erwartungen an eine soziale Position", "Eine Figur in einem Theaterstück", "Ein erlernter und ausgeübter Beruf"], correct: 0, explanation: "Zum Beispiel die Schüler- oder Elternrolle." },
    { category: "k11_sowi", question: "Was ist das Bruttoinlandsprodukt?", answers: ["Wert aller im Inland erzeugten Güter", "Das gesamte Vermögen des Staates", "Die Bilanz des Außenhandels"], correct: 0, explanation: "Ein zentraler Wohlstandsindikator." },
    { category: "k11_sowi", question: "Was sind Grundrechte?", answers: ["Rechte des Einzelnen gegenüber dem Staat", "Pflichten der Bürger gegenüber dem Staat", "Verbindliche Regeln der Europäischen Union"], correct: 0, explanation: "Sie stehen in den Artikeln 1-19 des Grundgesetzes." },

    // --- Klasse 11 - Informatik ---
    { category: "k11_informatik", question: "Was ist ein Array?", answers: ["Eine Liste gleichartiger Werte", "Eine einzelne feste Zahl", "Ein erklärender Kommentar"], correct: 0, explanation: "Auf Elemente greift man über einen Index zu." },
    ...
    { category: "k11_informatik", question: "Was ist eine Funktion in der Programmierung?", answers: ["Ein wiederverwendbarer Codeblock", "Ein benannter Speicherplatz", "Eine Art von Datentyp"], correct: 0, explanation: "Sie kann Parameter annehmen und Werte zurückgeben." },
    { category: "k11_informatik", question: "Was beschreibt die Laufzeit eines Algorithmus?", answers: ["Wie der Aufwand mit der Datenmenge wächst", "Wie lange der Rechner am Stück eingeschaltet ist", "Wie groß die erzeugte Datei am Ende wird"], correct: 0, explanation: "Angegeben z.B. in O-Notation." },

    // --- Klasse 12 - Deutsch ---
    { category: "k12_deutsch", question: "Was kennzeichnet den Sturm und Drang?", answers: ["Gefühl, Natur und Auflehnung gegen Regeln", "Strenge Vernunft und klare Formvorgaben", "Nüchterne Sachlichkeit ohne jedes Pathos"], correct: 0, explanation: "Goethes 'Die Leiden des jungen Werthers' ist typisch." },
    { category: "k12_deutsch", question: "Was ist die Weimarer Klassik?", answers: ["Streben nach Harmonie, Humanität und Maß", "Radikale Betonung des reinen Gefühls", "Bissige politische Satire in Versform"], correct: 0, explanation: "Hauptvertreter sind Goethe und Schiller." },
    { category: "k12_deutsch", question: "Was ist ein innerer Monolog?", answers: ["Ungefilterte Gedankenwiedergabe einer Figur", "Wechselrede zwischen zwei Bühnenfiguren", "Anweisung des Autors für die Inszenierung"], correct: 0, explanation: "Er gibt das Denken in der Ich-Form wieder." },
    { category: "k12_deutsch", question: "Was ist Expressionismus in der Literatur?", answers: ["Ausdruck innerer Zustände, oft verstörend", "Möglichst naturgetreue Abbildung der Welt", "Darstellung heiterer ländlicher Idylle"], correct: 0, explanation: "Typisch sind Großstadt-, Kriegs- und Weltuntergangsmotive." },
    ...
    { category: "k12_mathe", question: "Was berechnet ein bestimmtes Integral?", answers: ["Die Fläche zwischen Graph und x-Achse", "Die Steigung des Graphen an einer Stelle", "Die Stelle, an der der Graph null wird"], correct: 0, explanation: "Zwischen den angegebenen Grenzen." },
    { category: "k12_mathe", question: "Was ist ein Wendepunkt?", answers: ["Punkt, an dem die Krümmung wechselt", "Der höchste Punkt des ganzen Graphen", "Die Stelle mit dem Funktionswert null"], correct: 0, explanation: "Dort gilt f''(x) = 0 mit Vorzeichenwechsel." },
    { category: "k12_mathe", question: "Was ist ein Vektor?", answers: ["Eine Größe mit Betrag und Richtung", "Eine einzelne unbenannte Zahl", "Ein begrenztes Flächenstück"], correct: 0, explanation: "Zum Beispiel Kraft oder Geschwindigkeit." },
    ...
    { category: "k12_englisch", question: "Was bedeutet 'melting pot'?", answers: ["Bild für die Vermischung von Kulturen", "Ein Kochtopf zum Einschmelzen von Metall", "Ein Phänomen beim Abschmelzen der Pole"], correct: 0, explanation: "Klassisch auf die USA bezogen." },
    { category: "k12_englisch", question: "Was ist ein 'unreliable narrator'?", answers: ["Ein Erzähler, dem man nicht trauen kann", "Ein allwissender Erzähler außerhalb der Handlung", "Ein Erzähler, der aus der Ich-Perspektive spricht"], correct: 0, explanation: "Seine Darstellung ist bewusst verzerrt." },
    ...
    // --- Klasse 12 - Biologie ---
    { category: "k12_biologie", question: "Was ist die Proteinbiosynthese?", answers: ["Herstellung von Proteinen nach DNA-Bauplan", "Abbau von Proteinen zu einzelnen Bausteinen", "Teilung einer Zelle in zwei Tochterzellen"], correct: 0, explanation: "Sie läuft in Transkription und Translation ab." },
    ...
    { category: "k12_biologie", question: "Was ist Selektion in der Evolution?", answers: ["Auslese der besser angepassten Individuen", "Zufällige Veränderung des Erbmaterials", "Wanderung von Arten in neue Lebensräume"], correct: 0, explanation: "Sie wirkt auf die vorhandene Variabilität." },

    // --- Klasse 12 - Chemie ---
    { category: "k12_chemie", question: "Was ist ein Puffersystem?", answers: ["Es hält den pH-Wert weitgehend konstant", "Es beschleunigt den Ablauf einer Reaktion", "Es speichert Wärme über längere Zeit"], correct: 0, explanation: "Wichtig zum Beispiel im Blut." },
    { category: "k12_chemie", question: "Was ist die Elektronegativität?", answers: ["Maß für die Anziehung von Bindungselektronen", "Die gesamte positive Ladung des Atomkerns", "Die Masse eines Atoms in atomaren Einheiten"], correct: 0, explanation: "Fluor hat den höchsten Wert." },
    ...
    { category: "k12_chemie", question: "Was passiert in einer galvanischen Zelle?", answers: ["Chemische Energie wird zu elektrischer", "Strom erzwingt eine chemische Reaktion", "Es findet keinerlei Umwandlung statt"], correct: 0, explanation: "Das ist das Prinzip der Batterie." },
    ...
    { category: "k12_physik", question: "Was ist die Lorentzkraft?", answers: ["Kraft auf bewegte Ladungen im Magnetfeld", "Anziehungskraft zwischen zwei Massen", "Widerstandskraft zwischen zwei Flächen"], correct: 0, explanation: "Sie steht senkrecht zu Bewegung und Feld." },
    ...
    { category: "k12_geschichte", question: "Was war der Imperialismus?", answers: ["Streben der Großmächte nach Kolonien", "Eine weltweite schwere Wirtschaftskrise", "Eine bedeutende Epoche der Kunstgeschichte"], correct: 0, explanation: "Vor allem im späten 19. Jahrhundert." },
    { category: "k12_geschichte", question: "Was war die Weltwirtschaftskrise ab 1929?", answers: ["Eine schwere globale Wirtschaftskrise", "Ein langer Krieg zwischen Großmächten", "Eine verheerende Naturkatastrophe"], correct: 0, explanation: "Sie begann mit dem Börsencrash in New York." },
    { category: "k12_geschichte", question: "Was kennzeichnet eine Diktatur?", answers: ["Machtkonzentration ohne Gewaltenteilung", "Regelmäßige freie und geheime Wahlen", "Von der Politik unabhängige Gerichte"], correct: 0, explanation: "Opposition und Presse werden unterdrückt." },
    { category: "k12_geschichte", question: "Was war der Marshallplan?", answers: ["US-Wirtschaftshilfe für Europa ab 1947", "Ein militärischer Plan für den Ernstfall", "Ein Verbot des Handels mit dem Osten"], correct: 0, explanation: "Er sollte den Wiederaufbau fördern." },

    // --- Klasse 12 - Sozialwissenschaften ---
    { category: "k12_sowi", question: "Was ist Konjunkturpolitik?", answers: ["Staatliche Steuerung des Wirtschaftsverlaufs", "Ausschließlich die Erhöhung von Steuersätzen", "Ausschließlich das Sparen im Staatshaushalt"], correct: 0, explanation: "Zum Beispiel über Ausgaben oder Zinsen." },
    ...
    { category: "k12_sowi", question: "Was ist soziale Ungleichheit?", answers: ["Ungleiche Verteilung von Chancen und Mitteln", "Gleichbehandlung aller Menschen vor Gericht", "Ein festgelegter Begriff aus dem Grundgesetz"], correct: 0, explanation: "Betrifft Einkommen, Bildung und Gesundheit." },
    ...
    { category: "k12_informatik", question: "Was ist Rekursion?", answers: ["Eine Funktion ruft sich selbst auf", "Eine Schleife ohne jede Abbruchbedingung", "Ein Datentyp für sehr große Zahlen"], correct: 0, explanation: "Sie braucht immer eine Abbruchbedingung." },
    { category: "k12_informatik", question: "Was ist eine verkettete Liste?", answers: ["Struktur, in der Elemente aufeinander verweisen", "Ein Feld mit von Anfang an fester Größe", "Ein System zum Speichern großer Datenmengen"], correct: 0, explanation: "Jedes Element kennt seinen Nachfolger." },
    ...
    { category: "k12_informatik", question: "Was ist Datenkapselung?", answers: ["Interne Daten sind vor Zugriff geschützt", "Daten werden endgültig vom Träger gelöscht", "Daten werden mehrfach identisch kopiert"], correct: 0, explanation: "Zugriff erfolgt über definierte Methoden." },

    // --- Klasse 13 - Deutsch (Abitur) ---
    { category: "k13_deutsch", question: "Was ist ein episches Theater nach Brecht?", answers: ["Theater, das zum Nachdenken anregt", "Klassisches Theater mit voller Illusion", "Bühnenstück mit Gesang und Tanznummern"], correct: 0, explanation: "Mit Verfremdungseffekten wird Distanz erzeugt." },
    { category: "k13_deutsch", question: "Was ist Intertextualität?", answers: ["Bezüge eines Textes auf andere Texte", "Der Umfang eines Textes in Wörtern", "Der grammatische Aufbau eines Textes"], correct: 0, explanation: "Zitate und Anspielungen erzeugen Bedeutung." },
    { category: "k13_deutsch", question: "Was ist ein Sonett?", answers: ["Gedichtform mit vierzehn Versen", "Erzählwerk mit mehreren Handlungssträngen", "Bühnenstück mit Akten und Szenen"], correct: 0, explanation: "Typisch sind zwei Quartette und zwei Terzette." },
    { category: "k13_deutsch", question: "Was untersucht eine Sprachursprungstheorie?", answers: ["Wie menschliche Sprache entstanden ist", "Wie sich die Rechtschreibung entwickelt hat", "Woher einzelne Fremdwörter stammen"], correct: 0, explanation: "Herder ist ein bekannter Vertreter." },

    // --- Klasse 13 - Mathematik (Abitur) ---
    { category: "k13_mathe", question: "Wie berechnet man das Skalarprodukt zweier Vektoren?", answers: ["Komponentenweise multiplizieren und addieren", "Komponentenweise voneinander subtrahieren", "Die beiden Beträge miteinander multiplizieren"], correct: 0, explanation: "Ist es null, stehen die Vektoren senkrecht zueinander." },
    { category: "k13_mathe", question: "Was beschreibt die Binomialverteilung?", answers: ["Wahrscheinlichkeit von Treffern bei n Versuchen", "Verteilung stetiger Messwerte um einen Mittelwert", "Die Steigung einer Funktion an jeder Stelle"], correct: 0, explanation: "Zum Beispiel Münzwürfe mit zwei Ausgängen." },
    { category: "k13_mathe", question: "Was ist die Normalverteilung?", answers: ["Eine glockenförmige stetige Verteilung", "Eine gleichmäßig ansteigende Gerade", "Eine stufenförmige Treppenfunktion"], correct: 0, explanation: "Beschreibt viele natürliche Messgrößen." },
    { category: "k13_mathe", question: "Was ist eine Ebenengleichung in Parameterform?", answers: ["Ortsvektor plus zwei Spannvektoren", "Die Angabe eines einzelnen Punktes", "Eine einzelne reelle Zahl"], correct: 0, explanation: "E: x = a + r·u + s·v." },
    ...
    { category: "k13_englisch", question: "Was ist 'postcolonialism'?", answers: ["Auseinandersetzung mit den Folgen des Kolonialismus", "Eine Kunstepoche des frühen zwanzigsten Jahrhunderts", "Ein Wirtschaftsmodell für aufstrebende Staaten"], correct: 0, explanation: "Themen sind Identität, Macht und Sprache." },
    { category: "k13_englisch", question: "Was ist eine 'analysis of a cartoon'?", answers: ["Beschreibung und Deutung einer Karikatur", "Nacherzählung einer Bildergeschichte", "Wörtliche Übersetzung einer Bildunterschrift"], correct: 0, explanation: "Man beschreibt zuerst, deutet dann die Aussage." },
    ...
    { category: "k13_biologie", question: "Was ist die Genregulation?", answers: ["Steuerung, welche Gene abgelesen werden", "Die Teilung einer Zelle in zwei Hälften", "Die Summe aller Stoffwechselvorgänge"], correct: 0, explanation: "Das Operon-Modell beschreibt sie bei Bakterien." },
    { category: "k13_biologie", question: "Was ist ein Stoffkreislauf?", answers: ["Weg eines Stoffes durch das Ökosystem", "Der einmalige Verbrauch eines Rohstoffs", "Die Reihenfolge, wer wen frisst"], correct: 0, explanation: "Beispiel: Kohlenstoff- oder Stickstoffkreislauf." },
    ...
    { category: "k13_chemie", question: "Was ist eine Titration?", answers: ["Maßanalyse zur Konzentrationsbestimmung", "Trennverfahren mit einem feinen Filter", "Trennverfahren durch Verdampfen und Kühlen"], correct: 0, explanation: "Man gibt eine Maßlösung bis zum Äquivalenzpunkt zu." },
    ...
    { category: "k13_chemie", question: "Was ist die Nernst-Gleichung nützlich für?", answers: ["Berechnung von Elektrodenpotenzialen", "Berechnung der Masse eines Stoffes", "Berechnung des Volumens eines Gases"], correct: 0, explanation: "Sie berücksichtigt Konzentrationen." },
    ...
    { category: "k13_physik", question: "Was besagt die Heisenbergsche Unschärferelation?", answers: ["Ort und Impuls sind nicht gleichzeitig exakt bestimmbar", "Bei jedem Vorgang geht ein Teil der Energie verloren", "Licht verhält sich ausschließlich wie eine Welle"], correct: 0, explanation: "Ein Grundprinzip der Quantenphysik." },
    { category: "k13_physik", question: "Was ist der Welle-Teilchen-Dualismus?", answers: ["Objekte zeigen je nach Versuch beide Eigenschaften", "Alle Objekte verhalten sich ausschließlich wie Wellen", "Alle Objekte verhalten sich ausschließlich wie Teilchen"], correct: 0, explanation: "Gilt für Licht und für Materie." },
    { category: "k13_physik", question: "Was ist Kernfusion?", answers: ["Verschmelzung leichter Kerne unter Energiefreisetzung", "Spaltung schwerer Kerne unter Energiefreisetzung", "Zerfall instabiler Kerne unter Strahlungsabgabe"], correct: 0, explanation: "Sie liefert die Energie der Sonne." },
    { category: "k13_physik", question: "Was beschreibt die spezielle Relativitätstheorie?", answers: ["Raum und Zeit hängen vom Bezugssystem ab", "Ausschließlich die Wirkung der Schwerkraft", "Ausschließlich das Verhalten von Magneten"], correct: 0, explanation: "Einstein veröffentlichte sie 1905." },

    // --- Klasse 13 - Geschichte (Abitur) ---
    { category: "k13_geschichte", question: "Was war die deutsche Teilung?", answers: ["Trennung in BRD und DDR von 1949 bis 1990", "Die Aufteilung des Reiches nach der Gründung 1871", "Ein Streit um Kolonien vor dem Ersten Weltkrieg"], correct: 0, explanation: "Sie endete mit der Wiedervereinigung 1990." },
    { category: "k13_geschichte", question: "Was ist Vergangenheitsbewältigung?", answers: ["Auseinandersetzung mit der NS-Zeit und ihren Folgen", "Bewusstes Vergessen unangenehmer Geschichtsabschnitte", "Geschichtsschreibung ganz ohne Auswertung von Quellen"], correct: 0, explanation: "Erinnerungskultur ist ein zentrales Abiturthema." },
    { category: "k13_geschichte", question: "Was war die europäische Integration?", answers: ["Zusammenschluss europäischer Staaten seit 1951", "Die Teilung Europas in zwei feindliche Blöcke", "Ein Handelskrieg zwischen europäischen Staaten"], correct: 0, explanation: "Von der Montanunion bis zur heutigen EU." },
    { category: "k13_geschichte", question: "Was versteht man unter Modernisierung in der Geschichte?", answers: ["Wandel zu Industrie, Urbanisierung und Demokratie", "Bewusste Rückkehr zu bäuerlicher Lebensweise", "Ausschließlich der technische Fortschritt"], correct: 0, explanation: "Ein umfassender gesellschaftlicher Wandlungsprozess." },

    // --- Klasse 13 - Sozialwissenschaften (Abitur) ---
    { category: "k13_sowi", question: "Was sind die Institutionen der EU?", answers: ["Kommission, Parlament, Rat und Gerichtshof", "Ausschließlich das Europäische Parlament", "Ausschließlich die Europäische Kommission"], correct: 0, explanation: "Sie teilen sich Gesetzgebung und Kontrolle." },
    { category: "k13_sowi", question: "Was ist Globalisierungskritik?", answers: ["Hinterfragen der Folgen weltweiter Verflechtung", "Grundsätzliche Ablehnung jeglichen Handels", "Eine im Bundestag vertretene Partei"], correct: 0, explanation: "Themen sind Arbeitsbedingungen, Umwelt und Ungleichheit." },
    { category: "k13_sowi", question: "Was ist der Sozialstaat?", answers: ["Staat mit Verantwortung für soziale Sicherheit", "Staat, der auf jede Steuererhebung verzichtet", "Staat ohne verbindliche Gesetze und Regeln"], correct: 0, explanation: "Im Grundgesetz als Sozialstaatsprinzip verankert." },
    ...
    { category: "k13_informatik", question: "Was ist ein Sortieralgorithmus?", answers: ["Verfahren, um Daten in eine Reihenfolge zu bringen", "Ein Gerät zum dauerhaften Speichern von Daten", "Ein Regelwerk für die Übertragung im Netzwerk"], correct: 0, explanation: "Beispiele: Bubblesort, Quicksort, Mergesort." },
    { category: "k13_informatik", question: "Was bedeutet O(n log n)?", answers: ["Eine Aufwandsklasse effizienter Sortierverfahren", "Die Größe des belegten Arbeitsspeichers", "Eine Fehlermeldung beim Programmabsturz"], correct: 0, explanation: "Quicksort und Mergesort liegen im Mittel dort." },
    ...
    { category: "k13_informatik", question: "Was ist Kryptografie?", answers: ["Die Lehre vom Verschlüsseln von Informationen", "Das Verkleinern von Dateien ohne Qualitätsverlust", "Das nachträgliche Bearbeiten digitaler Bilder"], correct: 0, explanation: "Man unterscheidet symmetrische und asymmetrische Verfahren." },
    ...
    { category: "beruf_kfz", question: "Was bedeutet '205/55 R16' beim Reifen?", answers: ["Breite in mm, Höhe in %, Felge in Zoll", "Luftdruck, Gewicht und Baujahr", "Tragfähigkeit, Tempo und Profil"], correct: 0, explanation: "205 mm breit, Verhältnis 55 %, 16 Zoll Felge." },
    ...
    { category: "beruf_kfz", question: "Welche Aufgabe hat der Katalysator?", answers: ["Schadstoffe im Abgas umwandeln", "Kraftstoff vor dem Motor filtern", "Motoröl im Kreislauf reinigen"], correct: 0, explanation: "Er wandelt CO, HC und NOx in weniger schädliche Stoffe um." },
    ...
    { category: "spass_nice_to_know", question: "Kann Honig schlecht werden?", answers: ["Ja, nach einigen Monaten im Glas", "Nein, praktisch unbegrenzt haltbar", "Nur wenn er geöffnet gelagert wird"], correct: 1, explanation: "In ägyptischen Gräbern fand man noch genießbaren Honig." },
    ...
    { category: "k11_deutsch", question: "Was ist ein Leitmotiv in einem literarischen Werk?", answers: ["Ein wiederkehrendes Motiv mit besonderer Bedeutung", "Der einleitende erste Satz eines längeren Textes", "Die Lebensgeschichte des Autors im Anhang"], correct: 0, explanation: "Leitmotive tauchen mehrfach auf und tragen zur Deutung des Werks bei." },
    { category: "k11_deutsch", question: "Was ist eine auktoriale Erzählperspektive?", answers: ["Ein allwissender Erzähler außerhalb der Handlung", "Ein Erzähler, der selbst Figur der Handlung ist", "Ein Erzähler, der ganz ohne Wertung berichtet"], correct: 0, explanation: "Der auktoriale Erzähler kennt Gedanken aller Figuren und kommentiert das Geschehen." },
    { category: "k11_deutsch", question: "Was kennzeichnet einen Konflikt im Drama?", answers: ["Der Gegensatz gegnerischer Kräfte oder Interessen", "Die festgelegte Anzahl der Akte eines Stücks", "Der Umfang der Regieanweisungen im Text"], correct: 0, explanation: "Der Konflikt treibt die dramatische Handlung an und steuert auf einen Höhepunkt zu." },
    { category: "k11_deutsch", question: "Was ist ein Vergleich als sprachliches Mittel?", answers: ["Eine Gegenüberstellung mit 'wie' oder 'als'", "Eine bewusst starke sprachliche Übertreibung", "Eine Frage, auf die keine Antwort erwartet wird"], correct: 0, explanation: "Anders als die Metapher benennt der Vergleich das Vergleichswort ausdrücklich." },
    ...
    { category: "k11_englisch", question: "Was ist ein 'summary' im Englischunterricht?", answers: ["Eine sachliche Zusammenfassung im Present Tense", "Eine ausführlich begründete persönliche Meinung", "Eine möglichst wörtliche Übersetzung des Textes"], correct: 0, explanation: "Eine summary gibt den Inhalt sachlich, im Präsens und in eigenen Worten wieder." },
    ...
    { category: "k11_englisch", question: "Was ist 'characterisation' in der Textarbeit?", answers: ["Beschreibung einer Figur mit Belegen aus dem Text", "Nacherzählung der Handlung in eigenen Worten", "Darstellung der Lebensgeschichte des Autors"], correct: 0, explanation: "Eine characterisation beschreibt Aussehen, Verhalten und Entwicklung einer Figur, belegt am Text." },
    ...
    { category: "k11_biologie", question: "Was beschreibt das Schlüssel-Schloss-Prinzip?", answers: ["Die passgenaue Bindung von Substrat und Enzym", "Den geregelten Ablauf des gesamten Zellzyklus", "Den Weg des Blutes durch Herz und Gefäße"], correct: 0, explanation: "Nur ein räumlich passendes Substrat bindet an das aktive Zentrum des Enzyms." },
    { category: "k11_biologie", question: "Was ist Diffusion?", answers: ["Ausgleich von Konzentrationen ohne Energie", "Aktiver Transport gegen ein Konzentrationsgefälle", "Die Teilung einer Zelle in zwei Tochterzellen"], correct: 0, explanation: "Teilchen bewegen sich von hoher zu niedriger Konzentration – ein passiver Vorgang." },
    ...
    { category: "k11_physik", question: "Was besagt der Impulserhaltungssatz?", answers: ["Der Gesamtimpuls bleibt im System konstant", "Der Impuls wandelt sich stets vollständig in Wärme", "Der Impuls nimmt mit der Zeit von selbst ab"], correct: 0, explanation: "Ohne äußere Kräfte bleibt die Summe aller Impulse (m·v) erhalten – wichtig bei Stößen." },
    ...
    { category: "k11_physik", question: "Was ist der Wirkungsgrad einer Maschine?", answers: ["Verhältnis von nutzbarer zu zugeführter Energie", "Die abgegebene Leistung gemessen in Watt", "Die Zeitspanne des störungsfreien Betriebs"], correct: 0, explanation: "Der Wirkungsgrad ist immer kleiner als 1, da stets Energie als Wärme verloren geht." },

    { category: "k11_geschichte", question: "Was war die Aufklärung als Epoche?", answers: ["Geistesbewegung, die Vernunft und Mündigkeit betonte", "Eine lange Phase der Kriege im späten Mittelalter", "Eine Kunstrichtung im antiken Griechenland"], correct: 0, explanation: "Kant fasste sie als 'Ausgang des Menschen aus seiner selbstverschuldeten Unmündigkeit'." },
    { category: "k11_geschichte", question: "Was kennzeichnete die Industrialisierung in Deutschland?", answers: ["Fabrikarbeit, Urbanisierung und die soziale Frage", "Geplante Rückkehr zur bäuerlichen Landwirtschaft", "Auflösung der Städte zugunsten des Landlebens"], correct: 0, explanation: "Massenproduktion und Landflucht führten zu neuen sozialen Problemen und zur Arbeiterbewegung." },
    { category: "k11_geschichte", question: "Was ist eine Sekundärquelle?", answers: ["Eine spätere Darstellung über ein Ereignis", "Ein Bericht eines unmittelbaren Augenzeugen", "Ein Originaldokument aus der jeweiligen Zeit"], correct: 0, explanation: "Sekundärquellen deuten Ereignisse im Nachhinein, Primärquellen stammen aus der Zeit selbst." },
    { category: "k11_geschichte", question: "Was war die Deutsche Revolution von 1848/49?", answers: ["Ein Aufstand für Einheit, Freiheit und Verfassung", "Ein Aufstand der Bauern im späten Mittelalter", "Der unmittelbare Beginn des Ersten Weltkriegs"], correct: 0, explanation: "Die Nationalversammlung tagte in der Frankfurter Paulskirche, die Revolution scheiterte jedoch." },

    { category: "k11_sowi", question: "Was ist ein Markt in der Wirtschaft?", answers: ["Ort des Zusammentreffens von Angebot und Nachfrage", "Ein wöchentlich stattfindender Verkauf im Freien", "Eine staatliche Behörde zur Preisfestsetzung"], correct: 0, explanation: "Auf Märkten bildet sich über Angebot und Nachfrage der Preis." },
    { category: "k11_sowi", question: "Was ist eine Norm im soziologischen Sinn?", answers: ["Eine Verhaltenserwartung an Mitglieder einer Gruppe", "Ein ausnahmslos gültiges Gesetz der Natur", "Eine allgemein anerkannte mathematische Regel"], correct: 0, explanation: "Normen steuern Verhalten; bei Verstoß drohen Sanktionen." },
    { category: "k11_sowi", question: "Was bedeutet Gewaltenverschränkung?", answers: ["Gegenseitige Kontrolle der Staatsgewalten", "Die vollständige Abschaffung der Gewaltenteilung", "Die klare Trennung von Staat und Kirche"], correct: 0, explanation: "In der Praxis sind Legislative und Exekutive verschränkt, kontrollieren sich aber gegenseitig." },
    { category: "k11_sowi", question: "Was versteht man unter Opportunitätskosten?", answers: ["Der Nutzen der besten nicht gewählten Alternative", "Die auf einen erzielten Gewinn fälligen Steuern", "Die Kosten für die Reparatur einer Maschine"], correct: 0, explanation: "Wer sich für eine Option entscheidet, verzichtet auf den Nutzen der nächstbesten – das sind die Opportunitätskosten." },
    ...
    { category: "k11_informatik", question: "Was ist ein Boolescher Wert?", answers: ["Ein Wahrheitswert, also wahr oder falsch", "Eine Folge von Buchstaben und Zeichen", "Eine Zahl mit Nachkommastellen"], correct: 0, explanation: "Boolesche Werte steuern Bedingungen und Verzweigungen." },
    { category: "k11_informatik", question: "Was ist ein Struktogramm?", answers: ["Eine grafische Darstellung eines Algorithmus", "Ein Plan der elektrischen Verbindungen", "Eine Tabelle innerhalb einer Datenbank"], correct: 0, explanation: "Struktogramme (Nassi-Shneiderman-Diagramme) stellen Abläufe übersichtlich dar." },
    { category: "k12_deutsch", question: "Was kennzeichnet die Romantik als Literaturepoche?", answers: ["Sehnsucht, Naturverbundenheit und das Fantastische", "Strenge Orientierung an Vernunft und festen Regeln", "Nüchterne, sachliche Berichte über die Wirklichkeit"], correct: 0, explanation: "Die Romantik betont Gefühl, Fernweh und das Geheimnisvolle – Symbol ist die blaue Blume." },
    { category: "k12_deutsch", question: "Was ist eine Novelle als literarische Gattung?", answers: ["Erzählung mittlerer Länge um ein zentrales Ereignis", "Umfangreicher Roman über mehrere Bände hinweg", "Bühnenstück, das in fünf Akten aufgebaut ist"], correct: 0, explanation: "Kennzeichen sind die straffe Handlung um eine unerhörte Begebenheit und oft ein Dingsymbol." },
    { category: "k12_deutsch", question: "Was ist eine Antithese?", answers: ["Gegenüberstellung gegensätzlicher Begriffe", "Wiederholung desselben Wortes am Satzanfang", "Bewusste Untertreibung einer Aussage"], correct: 0, explanation: "Beispiel: 'Der eine lacht, der andere weint' – Gegensätze werden bewusst kontrastiert." },
    { category: "k12_deutsch", question: "Was ist der Realismus in der Literatur?", answers: ["Epoche, die Wirklichkeit maßvoll und geordnet zeigt", "Richtung mit fantastischen Welten und Zauberwesen", "Die überlieferte Literatur des antiken Griechenlands"], correct: 0, explanation: "Der poetische Realismus (ca. 1848-1890) zeigt Alltag, aber künstlerisch verklärt." },

    { category: "k12_mathe", question: "Was besagt der Hauptsatz der Differential- und Integralrechnung?", answers: ["Integration und Differentiation sind Umkehroperationen", "Jede beliebige Funktion ist an jeder Stelle stetig", "Die Ableitung einer Funktion ist stets positiv"], correct: 0, explanation: "Ist F eine Stammfunktion von f, gilt: Integral von a bis b = F(b) - F(a)." },
    ...
    { category: "k12_mathe", question: "Was beschreibt eine Geradengleichung in Parameterform?", answers: ["Stützvektor plus Vielfaches eines Richtungsvektors", "Die Lage eines einzelnen Punktes im Koordinatensystem", "Die Menge aller Punkte mit gleichem Abstand zum Mittelpunkt"], correct: 0, explanation: "g: x = a + t·u, wobei a der Stütz- und u der Richtungsvektor ist." },

    { category: "k12_englisch", question: "Was bedeutet 'to be aware of something'?", answers: ["Sich einer Sache bewusst sein", "Etwas entschieden ablehnen", "Etwas vollständig vergessen"], correct: 0, explanation: "'to be aware of' heißt, etwas wahrzunehmen oder sich dessen bewusst zu sein." },
    { category: "k12_englisch", question: "Was ist eine 'thesis statement'?", answers: ["Die zentrale Aussage eines Aufsatzes", "Die Überschrift über dem gesamten Text", "Das Verzeichnis der verwendeten Quellen"], correct: 0, explanation: "Sie fasst die Kernthese, die im Text belegt wird, in ein bis zwei Sätzen zusammen." },
    ...
    { category: "k12_englisch", question: "Was ist 'stereotyping'?", answers: ["Vereinfachte Bilder über ganze Gruppen", "Ein Druckverfahren aus dem Kunstunterricht", "Eine Zeitform der englischen Grammatik"], correct: 0, explanation: "Stereotype vereinfachen komplexe Wirklichkeit und können zu Vorurteilen führen." },
    ...
    { category: "k12_biologie", question: "Was besagen die Mendelschen Regeln?", answers: ["Gesetzmäßigkeiten der Vererbung von Merkmalen", "Grundregeln für den Ablauf der Fotosynthese", "Grundgesetze über Wärme und Energieumwandlung"], correct: 0, explanation: "Uniformitäts-, Spaltungs- und Unabhängigkeitsregel beschreiben Kreuzungsergebnisse." },
    { category: "k12_biologie", question: "Was ist die Meiose?", answers: ["Reifeteilung mit halbiertem Chromosomensatz", "Gewöhnliche Teilung einer Körperzelle", "Programmierter Tod einer einzelnen Zelle"], correct: 0, explanation: "Aus einer diploiden Zelle entstehen vier haploide Keimzellen." },
    ...
    { category: "k12_chemie", question: "Was ist eine Veresterung?", answers: ["Reaktion von Alkohol und Säure zu Ester", "Verbrennung eines Metalls unter Sauerstoff", "Bildung eines Salzes aus zwei Ionenarten"], correct: 0, explanation: "Die Veresterung ist eine Kondensationsreaktion und läuft im Gleichgewicht ab." },
    { category: "k12_chemie", question: "Was kennzeichnet Alkane?", answers: ["Gesättigte Kohlenwasserstoffe mit Einfachbindungen", "Kohlenwasserstoffe mit mindestens einer Dreifachbindung", "Sauerstoffhaltige Säuren mit Carboxygruppe"], correct: 0, explanation: "Alkane haben die allgemeine Formel CnH2n+2, z.B. Methan und Ethan." },
    { category: "k12_chemie", question: "Was ist der pKs-Wert?", answers: ["Ein Maß für die Stärke einer Säure", "Die Temperatur beim Übergang zum Gas", "Die Masse eines Mols eines Stoffes"], correct: 0, explanation: "Je kleiner der pKs-Wert, desto stärker die Säure." },
    { category: "k12_chemie", question: "Was sind Isomere?", answers: ["Gleiche Summenformel, unterschiedlicher Bau", "Verschiedene Stoffe mit derselben Farbe", "Zwei gebräuchliche Namen für denselben Stoff"], correct: 0, explanation: "Butan und Isobutan haben beide C4H10, unterscheiden sich aber in der Struktur und damit in ihren Eigenschaften." },

    { category: "k12_physik", question: "Was beschreibt das Induktionsgesetz?", answers: ["Spannung entsteht bei Änderung des Magnetflusses", "Elektrischer Strom fließt ausschließlich in Metallen", "Ein Teil der elektrischen Ladung geht dabei verloren"], correct: 0, explanation: "Grundlage von Generator und Transformator – eine Flussänderung erzeugt eine Induktionsspannung." },
    { category: "k12_physik", question: "Was ist die Kapazität eines Kondensators?", answers: ["Das Verhältnis von Ladung zu Spannung", "Die abgegebene Leistung gemessen in Watt", "Der elektrische Widerstand gemessen in Ohm"], correct: 0, explanation: "C = Q/U, gemessen in Farad." },
    { category: "k12_physik", question: "Was ist die Resonanz bei Schwingungen?", answers: ["Starke Zunahme der Amplitude bei passender Frequenz", "Allmähliches Abklingen einer Welle durch Reibung", "Umkehr der Bewegungsrichtung am Umkehrpunkt"], correct: 0, explanation: "Stimmt die Erregerfrequenz mit der Eigenfrequenz überein, wächst die Amplitude stark an." },
    ...
    { category: "k12_geschichte", question: "Warum gilt die Weimarer Republik als 'Demokratie ohne Demokraten'?", answers: ["Viele Eliten und Bürger lehnten die Republik ab", "In der gesamten Zeit fanden keine Wahlen statt", "Der Staat besaß zu keiner Zeit eine Verfassung"], correct: 0, explanation: "Justiz, Militär und Teile der Bevölkerung standen der Republik ablehnend gegenüber." },
    { category: "k12_geschichte", question: "Was war die Machtübertragung 1933?", answers: ["Hitlers Ernennung zum Reichskanzler", "Die Gründung der Bundesrepublik Deutschland", "Der Beginn des Ersten Weltkriegs in Europa"], correct: 0, explanation: "Reichspräsident Hindenburg ernannte Hitler; es folgte die rasche Ausschaltung der Demokratie." },
    ...
    { category: "k12_geschichte", question: "Was bedeutet 'Gleichschaltung' im Nationalsozialismus?", answers: ["Erzwungene Ausrichtung aller Bereiche auf die Ideologie", "Schrittweise Angleichung der Löhne in allen Berufen", "Technische Vereinheitlichung der deutschen Stromnetze"], correct: 0, explanation: "Parteien, Verbände und Länder wurden 1933/34 systematisch entmachtet oder unterworfen." },
    ...
    { category: "k12_sowi", question: "Was ist Angebotspolitik?", answers: ["Stärkung der Produktionsbedingungen der Unternehmen", "Erhöhung der staatlichen Nachfrage durch Ausgaben", "Überführung großer Unternehmen in Staatsbesitz"], correct: 0, explanation: "Angebotspolitik setzt auf Steuersenkungen und Deregulierung statt auf Nachfrageimpulse." },
    { category: "k12_sowi", question: "Was misst die Arbeitslosenquote?", answers: ["Anteil der Arbeitslosen an den Erwerbspersonen", "Die Gesamtzahl aller nicht erwerbstätigen Menschen", "Die Zahl der bei Betrieben gemeldeten offenen Stellen"], correct: 0, explanation: "Sie bezieht die registrierten Arbeitslosen auf alle zivilen Erwerbspersonen." },
    { category: "k12_sowi", question: "Was sind Interessenverbände?", answers: ["Organisationen, die Interessen ihrer Mitglieder vertreten", "Ministerien mit staatlichem Auftrag und Weisungsrecht", "Gerichte zur Entscheidung von Streitfällen"], correct: 0, explanation: "Gewerkschaften und Arbeitgeberverbände nehmen Einfluss auf politische Entscheidungen." },

    { category: "k12_informatik", question: "Was ist ein Stack (Stapelspeicher)?", answers: ["Eine Datenstruktur nach dem LIFO-Prinzip", "Eine Warteschlange nach dem FIFO-Prinzip", "Ein System zum Speichern großer Datenmengen"], correct: 0, explanation: "Last In, First Out: Das zuletzt abgelegte Element wird zuerst entnommen." },
    { category: "k12_informatik", question: "Was ist eine Queue?", answers: ["Eine Warteschlange nach dem FIFO-Prinzip", "Ein Stapelspeicher nach dem LIFO-Prinzip", "Ein Verfahren zum Ordnen von Datensätzen"], correct: 0, explanation: "First In, First Out – wie eine Warteschlange an der Kasse." },
    { category: "k12_informatik", question: "Wozu dient ein Primärschlüssel in einer Datenbank?", answers: ["Zur eindeutigen Identifikation eines Datensatzes", "Zur Verschlüsselung der gesamten Datenbank", "Zur alphabetischen Sortierung aller Spalten"], correct: 0, explanation: "Der Primärschlüssel ist eindeutig und darf nicht leer sein." },
    { category: "k12_informatik", question: "Was ist Vererbung in der objektorientierten Programmierung?", answers: ["Eine Klasse übernimmt Eigenschaften einer Oberklasse", "Das endgültige Löschen nicht mehr benötigter Objekte", "Das Anlegen identischer Kopien einzelner Dateien"], correct: 0, explanation: "Unterklassen erben Attribute und Methoden und können sie erweitern oder überschreiben." },
    { category: "k13_deutsch", question: "Was kennzeichnet die literarische Moderne um 1900?", answers: ["Brüche mit Traditionen und neue Erzählformen", "Strenge Regelpoetik nach dem Vorbild der Antike", "Ausschließlich Erzählungen über das Landleben"], correct: 0, explanation: "Autoren wie Kafka und Musil lösen sich von geschlossenen Formen und festen Weltbildern." },
    { category: "k13_deutsch", question: "Was ist eine Ellipse als Stilmittel?", answers: ["Ein unvollständiger Satz durch Auslassung", "Eine bewusst starke sprachliche Übertreibung", "Eine Gegenüberstellung mit 'wie' oder 'als'"], correct: 0, explanation: "Beispiel: 'Ende gut, alles gut' – Satzglieder werden bewusst weggelassen." },
    { category: "k13_deutsch", question: "Was untersucht die Sprachkritik?", answers: ["Wie Sprache Denken und Wirklichkeit beeinflusst", "Ausschließlich die Regeln der Rechtschreibung", "Die Geschichte des Buchdrucks seit Gutenberg"], correct: 0, explanation: "Sprachkritik fragt, ob und wie Sprache Wirklichkeit abbilden oder verschleiern kann." },
    { category: "k13_deutsch", question: "Was ist ein Bildungsroman?", answers: ["Roman über die innere Entwicklung einer Figur", "Sachbuch über das Schulwesen und seine Geschichte", "Sammlung von Gedichten eines einzelnen Autors"], correct: 0, explanation: "Klassisches Beispiel ist Goethes 'Wilhelm Meisters Lehrjahre'." },

    { category: "k13_mathe", question: "Was ist die Bernoulli-Kette?", answers: ["Wiederholte unabhängige Versuche mit zwei Ausgängen", "Eine Folge mehrfach hintereinander gebildeter Ableitungen", "Ein System aus mehreren zusammenhängenden Gleichungen"], correct: 0, explanation: "Sie ist die Grundlage der Binomialverteilung – jeder Versuch hat dieselbe Trefferwahrscheinlichkeit." },
    { category: "k13_mathe", question: "Was ist der Erwartungswert einer Zufallsgröße?", answers: ["Der auf lange Sicht durchschnittlich erwartete Wert", "Der größte Wert, den die Zufallsgröße annehmen kann", "Die Gesamtzahl der durchgeführten Einzelversuche"], correct: 0, explanation: "Bei der Binomialverteilung gilt E(X) = n·p." },
    { category: "k13_mathe", question: "Was ist ein Hypothesentest?", answers: ["Verfahren zur Prüfung einer Annahme anhand von Daten", "Untersuchung eines Funktionsgraphen auf Extrempunkte", "Verfahren zur Berechnung von Flächen unter Kurven"], correct: 0, explanation: "Man prüft, ob ein Stichprobenergebnis mit der Nullhypothese vereinbar ist." },
    ...
    { category: "k13_englisch", question: "Was ist 'utopia' und 'dystopia' in der Literatur?", answers: ["Idealer bzw. bedrohlicher Gesellschaftsentwurf", "Zwei Zeitformen der englischen Grammatik", "Zwei historische Städte im Süden Englands"], correct: 0, explanation: "Dystopien wie '1984' warnen vor gesellschaftlichen Fehlentwicklungen." },
    { category: "k13_englisch", question: "Was ist ein 'comment' als Aufgabenformat?", answers: ["Eine begründete eigene Stellungnahme", "Eine rein sachliche Inhaltsangabe", "Eine möglichst wörtliche Übersetzung"], correct: 0, explanation: "Im comment nimmt man Stellung, argumentiert und kommt zu einem klaren Fazit." },
    ...
    { category: "k13_biologie", question: "Was ist die Synapsengift-Wirkung am Beispiel von Hemmstoffen?", answers: ["Sie stören die Signalübertragung an der Synapse", "Sie beschleunigen die Teilung der Nervenzellen", "Sie verändern dauerhaft das Erbgut der Zelle"], correct: 0, explanation: "Hemmstoffe blockieren z.B. Rezeptoren oder den Abbau von Transmittern." },
    { category: "k13_biologie", question: "Was besagt die Endosymbiontentheorie?", answers: ["Zellorganellen stammen von aufgenommenen Bakterien ab", "Alle Zellen sind ursprünglich aus Kristallen entstanden", "Neue Arten entstehen völlig ohne natürliche Auslese"], correct: 0, explanation: "Beide Organellen besitzen eigene DNA und Doppelmembranen – starke Belege der Theorie." },
    { category: "k13_biologie", question: "Was ist genetische Drift?", answers: ["Zufällige Änderung der Allelhäufigkeit", "Gerichtete Auslese durch Umweltbedingungen", "Verdopplung des Erbmaterials vor der Teilung"], correct: 0, explanation: "Anders als die Selektion wirkt die Drift ungerichtet und besonders in kleinen Populationen stark." },
    { category: "k13_biologie", question: "Was ist ein ökologisches Gleichgewicht?", answers: ["Ein schwankender, aber insgesamt stabiler Zustand", "Ein über lange Zeit völlig unveränderlicher Zustand", "Das vollständige Aussterben aller beteiligten Arten"], correct: 0, explanation: "Populationsgrößen schwanken um einen Mittelwert, das System bleibt insgesamt stabil." },
    ...
    { category: "k13_chemie", question: "Was ist die Elektrolyse?", answers: ["Eine durch Strom erzwungene Redoxreaktion", "Eine von selbst ablaufende Batteriereaktion", "Ein Trennverfahren mit einem feinen Filter"], correct: 0, explanation: "Bei der Elektrolyse wird elektrische Energie zugeführt, um eine Reaktion zu erzwingen." },
    ...
    { category: "k13_physik", question: "Was beschreibt das Plancksche Wirkungsquantum?", answers: ["Zusammenhang von Energie und Frequenz eines Photons", "Die Ausbreitungsgeschwindigkeit des Lichts im Vakuum", "Die Stärke der Anziehung zwischen zwei Massen"], correct: 0, explanation: "E = h·f – Energie tritt nur in festen Portionen (Quanten) auf." },
    { category: "k13_physik", question: "Was ist der radioaktive Zerfall?", answers: ["Die spontane Umwandlung instabiler Atomkerne", "Die Verbrennung von Uran unter Sauerstoffzufuhr", "Die starke Erhitzung von Metall durch Strom"], correct: 0, explanation: "Man unterscheidet Alpha-, Beta- und Gammazerfall; die Halbwertszeit beschreibt das Tempo." },
    { category: "k13_physik", question: "Was ist die Halbwertszeit?", answers: ["Zeit, nach der die Hälfte der Kerne zerfallen ist", "Die durchschnittliche Lebensdauer eines Einzelatoms", "Die Hälfte der Ausbreitungsgeschwindigkeit von Licht"], correct: 0, explanation: "Sie ist für jedes Nuklid charakteristisch und unabhängig von der Ausgangsmenge." },
    { category: "k13_physik", question: "Was besagt die Zeitdilatation?", answers: ["Bewegte Uhren gehen für ruhende Beobachter langsamer", "Zeit vergeht für alle Beobachter überall genau gleich", "Zeit kann unter bestimmten Umständen rückwärts laufen"], correct: 0, explanation: "Ein Ergebnis der speziellen Relativitätstheorie, messbar z.B. bei Myonen." },

    { category: "k13_geschichte", question: "Was war die Kubakrise 1962?", answers: ["Zuspitzung des Kalten Krieges um Raketen auf Kuba", "Ein Handelsstreit zwischen Kuba und den USA um Zucker", "Der Zusammenschluss westlicher Staaten zur NATO"], correct: 0, explanation: "Die Welt stand kurz vor einem Atomkrieg; die Krise endete mit dem Abzug der Raketen." },
    ...
    { category: "k13_geschichte", question: "Was kennzeichnete die Friedliche Revolution 1989?", answers: ["Gewaltlose Massenproteste in der DDR", "Eine Machtübernahme durch das Militär", "Ein bewaffneter Konflikt im eigenen Land"], correct: 0, explanation: "Montagsdemonstrationen und der Ruf 'Wir sind das Volk' führten zum Fall der Mauer." },
    { category: "k13_geschichte", question: "Was war der Zwei-plus-Vier-Vertrag 1990?", answers: ["Außenpolitische Regelung der deutschen Einheit", "Ein Abkommen über den Handel innerhalb der EU", "Ein Bündnis zur gemeinsamen Verteidigung"], correct: 0, explanation: "Die beiden deutschen Staaten und die vier Siegermächte regelten die volle Souveränität Deutschlands." },

    { category: "k13_sowi", question: "Was ist der Europäische Binnenmarkt?", answers: ["Freier Verkehr von Waren, Personen und Kapital", "Ein gemeinsam veranstalteter europäischer Wochenmarkt", "Eine Behörde zur Überwachung der EU-Wirtschaft"], correct: 0, explanation: "Die vier Grundfreiheiten bilden das wirtschaftliche Kernstück der EU." },
    { category: "k13_sowi", question: "Wofür steht das Prinzip der Tarifautonomie?", answers: ["Gewerkschaften und Arbeitgeber handeln Löhne selbst aus", "Der Staat legt für alle Branchen die Löhne verbindlich fest", "Jeder Beschäftigte verhandelt seinen Lohn völlig allein"], correct: 0, explanation: "Die Tarifautonomie ist grundgesetzlich geschützt (Art. 9 Abs. 3 GG)." },
    { category: "k13_sowi", question: "Was ist das Umlageverfahren in der Rentenversicherung?", answers: ["Beiträge der Erwerbstätigen finanzieren heutige Renten", "Jeder spart ausschließlich für die eigene spätere Rente", "Der Staat zahlt sämtliche Renten allein aus Steuermitteln"], correct: 0, explanation: "Der Generationenvertrag gerät durch den demografischen Wandel unter Druck." },
    { category: "k13_sowi", question: "Was ist Multilateralismus?", answers: ["Zusammenarbeit mehrerer Staaten nach gemeinsamen Regeln", "Vorgehen eines einzelnen Staates ohne Absprache mit anderen", "Vollständiges Verbot des Handels zwischen zwei Staaten"], correct: 0, explanation: "Organisationen wie UNO, WTO und EU sind Ausdruck multilateraler Politik." },

    { category: "k13_informatik", question: "Was ist die Zeitkomplexität O(n²) typischerweise?", answers: ["Quadratisches Wachstum bei einfachen Sortierverfahren", "Gleichbleibende Laufzeit unabhängig von der Datenmenge", "Sehr langsam wachsender Aufwand bei großen Datenmengen"], correct: 0, explanation: "Bubblesort und Insertionsort liegen im schlechtesten Fall bei O(n²)." },
    { category: "k13_informatik", question: "Was ist eine reguläre Sprache?", answers: ["Eine Sprache, die ein endlicher Automat erkennen kann", "Eine gewachsene natürliche Sprache wie etwa Deutsch", "Eine Programmiersprache mit Klassen und Vererbung"], correct: 0, explanation: "Reguläre Sprachen lassen sich durch reguläre Ausdrücke beschreiben." },
    ...
    { category: "k13_informatik", question: "Wozu dient das Client-Server-Modell?", answers: ["Server bietet Dienste an, Client fragt sie ab", "Zum Ordnen großer Datenmengen nach festen Regeln", "Zum sicheren Verschlüsseln gespeicherter Passwörter"], correct: 0, explanation: "Webseiten, E-Mail und Datenbanken arbeiten typischerweise nach diesem Modell." },

    // --- BERUFSSCHULE: ELEKTRONIKER/IN ---
    { category: "beruf_elektro", question: "Wie lauten die fünf Sicherheitsregeln der Elektrotechnik in der richtigen Reihenfolge?", answers: ["Freischalten, sichern, prüfen, erden, abdecken", "Erden, freischalten, messen, abdecken, sichern", "Messen, abdecken, freischalten, erden, sichern"], correct: 0, explanation: "Die Reihenfolge ist verbindlich und schützt vor Stromunfällen." },
    ...
    { category: "beruf_elektro", question: "Wozu dient ein FI-Schutzschalter (RCD)?", answers: ["Er trennt bei Fehlerströmen und schützt Personen", "Er begrenzt die Spannung im gesamten Stromkreis", "Er misst den Stromverbrauch für die Abrechnung"], correct: 0, explanation: "Der RCD vergleicht Hin- und Rückstrom und löst bei einer Differenz (Fehlerstrom) aus." },
    { category: "beruf_elektro", question: "Was passiert mit dem Gesamtwiderstand in einer Parallelschaltung?", answers: ["Er wird kleiner als der kleinste Einzelwiderstand", "Er ist die Summe aller beteiligten Widerstände", "Er bleibt unverändert wie bei einem Einzelteil"], correct: 0, explanation: "Bei Parallelschaltung addieren sich die Leitwerte, der Gesamtwiderstand sinkt." },
    { category: "beruf_elektro", question: "Was gibt der Nennstrom einer Sicherung an?", answers: ["Den Strom, den sie dauerhaft führen darf", "Die Spannung, die im Stromkreis anliegt", "Den Widerstand der angeschlossenen Leitung"], correct: 0, explanation: "Die Sicherung schützt vor allem die Leitung vor Überlastung und Brand." },
    { category: "beruf_elektro", question: "Warum wählt man bei langen Leitungen einen größeren Querschnitt?", answers: ["Um Spannungsfall und Erwärmung zu begrenzen", "Damit die Leitung mechanisch stabiler wird", "Um die Spannung am Ende zu erhöhen"], correct: 0, explanation: "Ein größerer Querschnitt senkt den Leitungswiderstand und damit den Spannungsfall." },
    ...
    { category: "beruf_elektro", question: "Was ist der Unterschied zwischen Gleichstrom und Wechselstrom?", answers: ["Gleichstrom fließt immer in eine Richtung", "Gleichstrom ist grundsätzlich der stärkere", "Beide unterscheiden sich nur im Namen"], correct: 0, explanation: "Im deutschen Netz beträgt die Frequenz des Wechselstroms 50 Hz." },
    ...
    { category: "beruf_tischler", question: "Was ist eine Zinkenverbindung?", answers: ["Eine Eckverbindung aus ineinandergreifenden Zapfen", "Eine Verbindung mit aufgenageltem Zinkblech", "Eine stumpf verleimte Verbindung ohne Zapfen"], correct: 0, explanation: "Schwalbenschwanzzinken sind besonders zugfest und ein Qualitätsmerkmal im Möbelbau." },
    { category: "beruf_tischler", question: "Warum arbeitet Holz auch nach der Verarbeitung noch?", answers: ["Es nimmt Feuchtigkeit auf und gibt sie ab", "Es wächst auch nach dem Verbauen weiter", "Es verändert sich durch Lichteinstrahlung"], correct: 0, explanation: "Holz quillt und schwindet quer zur Faser deutlich stärker als in Längsrichtung." },
    { category: "beruf_tischler", question: "Wofür wird ein Stechbeitel verwendet?", answers: ["Zum Ausstemmen von Vertiefungen und Zapfenlöchern", "Zum geraden Ablängen von breiten Brettern", "Zum Feinschleifen sichtbarer Oberflächen"], correct: 0, explanation: "Der Stechbeitel wird mit dem Klüpfel oder von Hand geführt." },
    { category: "beruf_tischler", question: "Was ist Furnier?", answers: ["Ein dünnes Echtholzblatt zum Beschichten", "Eine schützende Lackschicht für Möbel", "Ein Spezialkleber für Holzverbindungen"], correct: 0, explanation: "Furniere sind meist 0,5 bis 0,9 mm dick und sparen wertvolles Vollholz." },
    ...
    { category: "beruf_tischler", question: "Wozu dient eine Absauganlage in der Werkstatt?", answers: ["Sie entfernt gesundheitsschädlichen Holzstaub", "Sie kühlt die Motoren der Maschinen", "Sie erhöht die Drehzahl der Sägeblätter"], correct: 0, explanation: "Holzstaub gilt als krebserzeugend, besonders Eichen- und Buchenstaub." },

    // --- BERUFSSCHULE: INDUSTRIEMECHANIKER/IN ---
    { category: "beruf_industriemechaniker", question: "Womit misst man Längen auf Hundertstelmillimeter genau?", answers: ["Mit der Bügelmessschraube (Mikrometer)", "Mit einem geeichten Gliedermaßstab", "Mit einem gespannten Stahlmaßband"], correct: 0, explanation: "Der Messschieber schafft üblicherweise 0,05 mm, die Bügelmessschraube 0,01 mm." },
    { category: "beruf_industriemechaniker", question: "Was bedeutet die Bezeichnung M8 bei einer Schraube?", answers: ["Metrisches Gewinde mit 8 mm Durchmesser", "Materialgüte der Stufe 8 nach Norm", "Schlüsselweite von 8 mm am Kopf"], correct: 0, explanation: "M steht für metrisches ISO-Gewinde, die Zahl gibt den Außendurchmesser in mm an." },
    { category: "beruf_industriemechaniker", question: "Was versteht man unter einer Passung?", answers: ["Das Zusammenspiel der Toleranzen von Welle und Bohrung", "Die Oberflächenfarbe des fertigen Werkstücks", "Die Gesamtlänge eines gefertigten Bauteils"], correct: 0, explanation: "Man unterscheidet Spiel-, Übergangs- und Presspassung." },
    { category: "beruf_industriemechaniker", question: "Welches Fertigungsverfahren ist Drehen?", answers: ["Spanendes Verfahren mit rotierendem Werkstück", "Umformendes Verfahren ohne Materialabtrag", "Fügendes Verfahren zum Verbinden von Teilen"], correct: 0, explanation: "Beim Drehen rotiert das Werkstück, das Werkzeug führt die Vorschubbewegung aus." },
    { category: "beruf_industriemechaniker", question: "Wozu dient das Härten von Stahl?", answers: ["Zur Erhöhung von Härte und Verschleißfestigkeit", "Zum Weichmachen für die spätere Bearbeitung", "Zum dauerhaften Schutz vor Rostbildung"], correct: 0, explanation: "Beim Härten wird der Stahl erhitzt und schnell abgeschreckt; danach folgt meist das Anlassen." },
    { category: "beruf_industriemechaniker", question: "Was zeigt eine technische Zeichnung in der Vorderansicht?", answers: ["Die Hauptansicht nach Projektionsmethode 1", "Grundsätzlich die Rückseite des Bauteils", "Ausschließlich Maße ohne erkennbare Form"], correct: 0, explanation: "In Europa gilt die Projektionsmethode 1 (Erstwinkelprojektion)." },
    { category: "beruf_industriemechaniker", question: "Warum verwendet man beim Zerspanen Kühlschmierstoff?", answers: ["Zur Kühlung, Schmierung und zum Späneabtransport", "Ausschließlich zur Reinigung nach der Arbeit", "Zur farblichen Kennzeichnung des Werkstücks"], correct: 0, explanation: "Kühlschmierstoff verlängert die Standzeit des Werkzeugs und verbessert die Oberfläche." },
    { category: "beruf_industriemechaniker", question: "Was ist eine Presspassung?", answers: ["Die Welle ist größer als die Bohrung", "Zwischen den Teilen bleibt immer Spiel", "Die Teile werden nur lose gesteckt"], correct: 0, explanation: "Presspassungen übertragen Kräfte durch Reibschluss, oft mit Erwärmen gefügt." },
    ...
    { category: "beruf_fachinformatiker", question: "Welche Aufgabe hat ein DNS-Server?", answers: ["Er übersetzt Domainnamen in IP-Adressen", "Er speichert eingehende E-Mails zwischen", "Er verschlüsselt Passwörter beim Anmelden"], correct: 0, explanation: "Ohne DNS müsste man IP-Adressen statt Namen wie beispiel.de eingeben." },
    ...
    { category: "beruf_fachinformatiker", question: "Wozu dient eine Firewall?", answers: ["Sie filtert den Netzwerkverkehr nach Regeln", "Sie beschleunigt die Internetverbindung", "Sie sichert Daten automatisch auf Band"], correct: 0, explanation: "Firewalls erlauben oder blockieren Verbindungen anhand von Ports, Adressen und Protokollen." },
    { category: "beruf_fachinformatiker", question: "Was ist der Unterschied zwischen Hardware und Software?", answers: ["Hardware ist die Technik, Software sind Programme", "Software ist grundsätzlich das Teurere von beidem", "Beide bezeichnen dasselbe mit anderem Namen"], correct: 0, explanation: "Hardware ist der physische Teil, Software die Menge der Programme und Daten." },
    ...
    { category: "beruf_buero", question: "Was bedeutet 'Skonto' auf einer Rechnung?", answers: ["Ein Preisnachlass bei schneller Zahlung", "Ein Zuschlag bei verspäteter Zahlung", "Der auf den Betrag entfallende Steueranteil"], correct: 0, explanation: "Beispiel: '2 % Skonto bei Zahlung innerhalb von 10 Tagen'." },
    ...
    { category: "beruf_buero", question: "Wodurch kommt ein Kaufvertrag zustande?", answers: ["Durch zwei übereinstimmende Willenserklärungen", "Erst durch die vollständige Bezahlung", "Erst durch die Lieferung der Ware"], correct: 0, explanation: "Antrag und Annahme genügen; ein schriftlicher Vertrag ist meist nicht nötig." },
    { category: "beruf_buero", question: "Was regelt die DIN 5008?", answers: ["Die Gestaltung von Geschäftsbriefen", "Die Maße von Büromöbeln am Arbeitsplatz", "Die zulässigen Arbeitszeiten im Büro"], correct: 0, explanation: "Sie legt Abstände, Anschriftfeld und Aufbau von Geschäftsbriefen fest." },
    { category: "beruf_buero", question: "Was ist eine Inventur?", answers: ["Die Erfassung aller Vermögenswerte", "Ein Werbeprospekt für Stammkunden", "Eine Befragung zur Kundenzufriedenheit"], correct: 0, explanation: "Die Inventur ist gesetzlich vorgeschrieben und Grundlage des Inventars." },
    { category: "beruf_buero", question: "Was ist ein Verzug beim Zahlungsziel?", answers: ["Die verspätete Zahlung nach Fälligkeit", "Ein Preisnachlass bei sofortiger Zahlung", "Eine Zahlung noch vor der Lieferung"], correct: 0, explanation: "Nach Verzugseintritt können Verzugszinsen und Mahnkosten verlangt werden." },
    { category: "beruf_buero", question: "Was gehört zu den Aufgaben der Ablageorganisation?", answers: ["Systematisches Ordnen und Aufbewahren von Dokumenten", "Das Bestellen von Waren beim Lieferanten", "Die Einsatzplanung des gesamten Personals"], correct: 0, explanation: "Wichtig sind einheitliche Ordnungssysteme und die Beachtung von Aufbewahrungsfristen." },
    ...
    { category: "beruf_verkaeufer", question: "Was ist bei der Warenannahme zuerst zu prüfen?", answers: ["Menge, Art und Zustand laut Lieferschein", "Ausschließlich der ausgezeichnete Verkaufspreis", "Ausschließlich das aufgedruckte Haltbarkeitsdatum"], correct: 0, explanation: "Mängel müssen sofort dokumentiert und gemeldet werden." },
    ...
    { category: "beruf_verkaeufer", question: "Muss ein Geschäft einwandfreie Ware umtauschen, die dem Kunden nicht gefällt?", answers: ["Nein, ein Umtausch ist dabei freiwillig", "Ja, immer innerhalb von 14 Tagen", "Ja, zeitlich völlig unbegrenzt"], correct: 0, explanation: "Im Ladengeschäft besteht kein gesetzliches Umtauschrecht bei Nichtgefallen – anders als im Onlinehandel." },
    { category: "beruf_verkaeufer", question: "Was versteht man unter Warenpräsentation?", answers: ["Die verkaufsfördernde Anordnung im Laden", "Die platzsparende Lagerung im Keller", "Die Buchführung über alle Verkäufe"], correct: 0, explanation: "Sichtzone und Griffzone in Augen- und Handhöhe verkaufen am besten." },
    { category: "beruf_verkaeufer", question: "Was ist ein 'offenes Fragen' im Verkaufsgespräch?", answers: ["Eine Frage, die nicht mit Ja oder Nein geht", "Eine Frage, die den Kunden bewusst drängt", "Eine Frage ausschließlich nach dem Preis"], correct: 0, explanation: "W-Fragen wie 'Wofür möchten Sie es nutzen?' bringen den Kunden ins Erzählen." },
    { category: "beruf_verkaeufer", question: "Was bedeutet die Preisangabenverordnung für den Einzelhandel?", answers: ["Preise müssen inklusive Mehrwertsteuer erkennbar sein", "Preise dürfen bewusst unauffällig platziert werden", "Die Regel gilt ausschließlich für Onlineshops"], correct: 0, explanation: "Verbraucher müssen den Endpreis auf einen Blick erkennen können." },
    { category: "beruf_verkaeufer", question: "Wie reagiert man richtig auf eine Reklamation?", answers: ["Zuhören, Verständnis zeigen, Lösung anbieten", "Den Kunden freundlich, aber bestimmt abweisen", "Den Fehler bestreiten und auf Hersteller verweisen"], correct: 0, explanation: "Eine gut gelöste Reklamation stärkt oft die Kundenbindung." },
    { category: "beruf_verkaeufer", question: "Was ist Warenschwund im Einzelhandel?", answers: ["Ungeplanter Verlust durch Diebstahl oder Verderb", "Der geplante Abverkauf über Rabattaktionen", "Der gesamte Umsatz eines Verkaufstages"], correct: 0, explanation: "Der Schwund wird über die Inventur ermittelt und mindert den Gewinn." },

    // --- BERUFSSCHULE: PFLEGEFACHKRAFT ---
    { category: "beruf_pflege", question: "Welche Werte zählen zu den Vitalzeichen?", answers: ["Puls, Blutdruck, Atmung und Temperatur", "Ausschließlich der gemessene Blutdruck", "Körpergröße und aktuelles Körpergewicht"], correct: 0, explanation: "Vitalzeichen geben Auskunft über die lebenswichtigen Körperfunktionen." },
    ...
    { category: "beruf_pflege", question: "Was versteht man unter Dekubitusprophylaxe?", answers: ["Maßnahmen zur Vorbeugung von Druckgeschwüren", "Maßnahmen zur Vorbeugung von Stürzen", "Maßnahmen zur Vorbeugung von Erkältungen"], correct: 0, explanation: "Regelmäßige Positionswechsel, Hautpflege und Druckentlastung sind zentral." },
    { category: "beruf_pflege", question: "Welche Schritte umfasst der Pflegeprozess?", answers: ["Sammeln, Planen, Durchführen, Auswerten", "Ausschließlich das Dokumentieren am Ende", "Ausschließlich die ärztliche Visite"], correct: 0, explanation: "Der Pflegeprozess ist ein Regelkreis und wird laufend angepasst." },
    { category: "beruf_pflege", question: "Warum ist die Pflegedokumentation so wichtig?", answers: ["Sie sichert Qualität und rechtliche Absicherung", "Sie ist eine reine Formsache ohne Bedeutung", "Sie ersetzt die mündliche Übergabe komplett"], correct: 0, explanation: "Was nicht dokumentiert ist, gilt im Streitfall als nicht durchgeführt." },
    { category: "beruf_pflege", question: "Was gilt für die Schweigepflicht in der Pflege?", answers: ["Patientendaten dürfen nicht unbefugt weiter", "Angehörige dürfen stets alle Details erfahren", "Sie betrifft ausschließlich ärztliches Personal"], correct: 0, explanation: "Die Schweigepflicht ist strafbewehrt (§ 203 StGB) und gilt auch für Auszubildende." },
    ...
    { category: "beruf_pflege", question: "Was ist ein Ziel der Sturzprophylaxe?", answers: ["Risiken erkennen und Umgebung sicher gestalten", "Bewegung soweit wie möglich ganz vermeiden", "Betroffene dauerhaft im Bett liegen lassen"], correct: 0, explanation: "Bewegungsförderung, gutes Schuhwerk und freie Wege senken das Sturzrisiko." },
    ...
    { category: "beruf_friseur", question: "Was bewirkt Wasserstoffperoxid beim Färben?", answers: ["Es öffnet die Schuppenschicht und entwickelt Farbe", "Es kühlt die Kopfhaut während der Einwirkzeit", "Es fixiert die fertige Frisur dauerhaft"], correct: 0, explanation: "H2O2 oxidiert die Farbstoffvorstufen und hellt gleichzeitig das Naturpigment auf." },
    { category: "beruf_friseur", question: "Welche zwei Schritte umfasst eine Dauerwelle?", answers: ["Reduktion (Umformen) und anschließende Fixierung", "Gründliches Waschen und anschließendes Föhnen", "Stufiges Schneiden und abschließendes Tönen"], correct: 0, explanation: "Das Wellmittel öffnet die Schwefelbrücken, die Fixierung schließt sie in neuer Form." },
    { category: "beruf_friseur", question: "Warum wird vor einer Coloration eine Verträglichkeitsprobe empfohlen?", answers: ["Um allergische Reaktionen auszuschließen", "Um den genauen Preis vorab zu ermitteln", "Um die Haarlänge exakt zu bestimmen"], correct: 0, explanation: "Besonders PPD in Oxidationsfarben kann Allergien auslösen." },
    ...
    { category: "beruf_friseur", question: "Was ist das Ziel einer Kundenberatung vor dem Schnitt?", answers: ["Wünsche, Haarstruktur und Gesichtsform abstimmen", "Möglichst viele teure Pflegeprodukte verkaufen", "Die Dauer des Termins deutlich verkürzen"], correct: 0, explanation: "Eine gute Beratung verhindert Missverständnisse und Reklamationen." },
    { category: "beruf_friseur", question: "Was passiert beim Blondieren mit dem Haar?", answers: ["Die natürlichen Pigmente werden aufgehellt", "Zusätzliche Farbpigmente werden eingelagert", "Die Schuppenschicht wird dauerhaft verdichtet"], correct: 0, explanation: "Blondieren belastet das Haar stark, deshalb sind Pflege und Abstände wichtig." },
    ...
    { category: "spass_musik", question: "Was ist ein 'Refrain' in einem Lied?", answers: ["Der wiederkehrende Teil zwischen den Strophen", "Der allererste Ton am Anfang des Stücks", "Das leise Instrument im Hintergrund"], correct: 0, explanation: "Der Refrain wiederholt sich und bleibt am besten im Ohr." },
    ...
    { category: "spass_tiere", question: "Wie viele Beine hat ein Tausendfüßler tatsächlich meistens?", answers: ["Deutlich weniger als tausend", "Ziemlich genau eintausend", "Deutlich mehr als fünftausend"], correct: 0, explanation: "Die meisten Arten haben zwischen 30 und 400 Beine." },
    ...
    { category: "spass_tiere", question: "Wie verständigen sich Bienen über Futterquellen?", answers: ["Mit einem Schwänzeltanz im Stock", "Mit unterschiedlich hohem Summen", "Mit farbigen Markierungen am Eingang"], correct: 0, explanation: "Der Tanz verrät Richtung und Entfernung zur Blüte." },
    ...
    { category: "spass_laender", question: "An welches Land grenzt Deutschland im Süden?", answers: ["Österreich und die Schweiz", "Dänemark und Schweden", "Polen und Tschechien"], correct: 0, explanation: "Deutschland hat insgesamt neun Nachbarländer." },
    ...
    { category: "spass_erfindungen", question: "Was war der Zweck der ersten Glühbirne?", answers: ["Elektrisches Licht ohne offene Flamme", "Wärme für kalte Wohnräume erzeugen", "Töne über weite Strecken verstärken"], correct: 0, explanation: "Thomas Edison machte sie ab 1879 alltagstauglich." },
    ...
    { category: "spass_erfindungen", question: "Was macht ein 3D-Drucker?", answers: ["Er baut Gegenstände Schicht für Schicht auf", "Er druckt besonders farbtreue Fotos", "Er erfasst Vorlagen und speichert sie"], correct: 0, explanation: "Dieses Verfahren nennt man additive Fertigung." },
    ...
    { category: "spass_raetsel", question: "Was ist schwerer: 1 kg Federn oder 1 kg Blei?", answers: ["Beides ist exakt gleich schwer", "Das Blei, es ist viel dichter", "Die Federn, es sind mehr davon"], correct: 0, explanation: "Ein Kilogramm ist ein Kilogramm – nur das Volumen unterscheidet sich." },
    ...
    { category: "spass_nice_to_know", question: "Nice to know: Warum ist der Himmel blau?", answers: ["Blaues Licht wird in der Luft am stärksten gestreut", "Weil sich das Blau der Ozeane oben spiegelt", "Weil die Sonne selbst bläulich leuchtet"], correct: 0, explanation: "Man nennt das Rayleigh-Streuung." },
    ...
    { category: "spass_nice_to_know", question: "Nice to know: Warum gähnen Menschen ansteckend?", answers: ["Vermutlich durch Empathie und Spiegelneurone", "Wegen zu wenig Sauerstoff im ganzen Raum", "Reiner Zufall ohne jeden Zusammenhang"], correct: 0, explanation: "Je näher man sich steht, desto ansteckender wirkt das Gähnen." },
    ...
    { category: "spass_sport_film", question: "Was ist ein 'Cliffhanger' im Film?", answers: ["Ein Spannungsende, das offen bleibt", "Eine besonders lange Verfolgungsjagd", "Der Abspann mit allen Mitwirkenden"], correct: 0, explanation: "Cliffhanger sollen die Zuschauer zur nächsten Folge locken." },
    ...
    { category: "spass_humor", question: "Was bedeutet 'kurz' auf Deutsch?", answers: ["Zuverlässig weniger als eine Minute", "Höchstens fünf Minuten, wie versprochen", "Irgendwas zwischen 5 Minuten und 3 Stunden"], correct: 2, explanation: "⏰ 'Ich bin kurz weg' = Komm in 3 Stunden wieder!" },
    ...
    { category: "spass_humor", question: "Wofür steht die Abkürzung 'Muttizettel'?", answers: ["Mütterliche Unterschrift auf Testarbeit", "Mutti, toleriere meinen Zockerabend", "Mündliche Unverbindliche Teilnahme-Toleranz"], correct: 2, explanation: "📝 Bürokratisch korrekt: M.U.T.T.! Egal was draufsteht – Hauptsache unterschrieben!" },
    ...
    { category: "spass_humor", question: "Was passiert, wenn der Lehrer sagt 'Ich brauche einen Freiwilligen'?", answers: ["Sofort schnellen alle Arme nach oben", "Der Klassenbeste steht routiniert auf", "Plötzlich sind alle Schnürsenkel interessant"], correct: 2, explanation: "👀 Nie war der Fußboden so spannend wie in diesem Moment!" },
    ...
    { category: "spass_beruf_humor", question: "KFZ: Was sagt der Kunde, wenn der Motor klopft?", answers: ["'Da ist irgendwas kaputt gegangen'", "'Der klopft eigentlich schon immer so'", "'Gucken Sie mal schnell? Dauert nur 5 Minuten'"], correct: 2, explanation: "⏱️ 'Nur 5 Minuten' = KFZ-Albtraum! In Wahrheit mindestens 5 Stunden." },
    { category: "spass_beruf_humor", noShuffle: true, question: "KFZ: Was bleibt nach jeder Reparatur übrig?", answers: ["Genau eine übrig gebliebene Schraube", "Ein Werkzeug, das keiner mehr findet", "Beides – und keiner weiß, wo es hingehört"], correct: 2, explanation: "🔩 Zwei Schrauben übrig? Das Auto ist jetzt leichter = schneller!" },
    ...
    { category: "spass_beruf_humor", question: "IT: Was ist die Lösung für 99 Prozent aller IT-Probleme?", answers: ["Das Netzwerkkabel einmal umdrehen", "Deutlich lauter mit dem Gerät schimpfen", "'Haben Sie es aus- und wieder eingeschaltet?'"], correct: 2, explanation: "🖥️ Der IT-Support-Klassiker – und er funktioniert WIRKLICH meistens!" },
    { category: "spass_beruf_humor", question: "Büro: Was bedeutet 'Ich melde mich zeitnah'?", answers: ["Verlässlich innerhalb einer Stunde", "Ganz sicher noch am selben Tag", "Irgendwann zwischen morgen und nie"], correct: 2, explanation: "📧 'Zeitnah' ist die höflichste Art, 'keine Ahnung wann' zu sagen." },
    { category: "spass_beruf_humor", question: "Einzelhandel: Wann kommt der letzte Kunde?", answers: ["Kurz nach der Mittagspause", "Am frühen ruhigen Nachmittag", "Genau eine Minute vor Ladenschluss"], correct: 2, explanation: "🛒 Und er braucht dann natürlich eine ausführliche Beratung." },
    ...
    { category: "spass_beruf_humor", question: "Handwerk: Was heißt 'Ich komme dann Dienstag'?", answers: ["Am kommenden Dienstag pünktlich", "Spätestens übernächsten Dienstag", "Irgendeinen Dienstag in diesem Jahr"], correct: 2, explanation: "🔨 Die Handwerker-Woche hat bekanntlich sehr viele Dienstage." },
...
const VOCABULARY_DATABASE = {
    en: {
        k1: {
            ...
            words: [
                {de:"Mama",foreign:"mommy"}, {de:"Papa",foreign:"daddy"}, {de:"Bruder",foreign:"brother"}, {de:"Schwester",foreign:"sister"}, {de:"Oma",foreign:"grandma"}, {de:"Opa",foreign:"grandpa"}, {de:"Hund",foreign:"dog"}, {de:"Katze",foreign:"cat"}, {de:"Fisch",foreign:"fish"}, {de:"Vogel",foreign:"bird"}, {de:"Haus",foreign:"house"}, {de:"Baum",foreign:"tree"}, {de:"Blume",foreign:"flower"}, {de:"Sonne",foreign:"sun"}, {de:"Mond",foreign:"moon"}, {de:"Stern",foreign:"star"}, {de:"Apfel",foreign:"apple"}, {de:"Banane",foreign:"banana"}, {de:"Milch",foreign:"milk"}, {de:"Brot",foreign:"bread"}, {de:"Wasser",foreign:"water"}, {de:"Saft",foreign:"juice"}, {de:"Auto",foreign:"car"}, {de:"Zug",foreign:"train"}, {de:"Flugzeug",foreign:"plane"}, {de:"Schiff",foreign:"boat"}
            ]
        },
        k2: {
            label: "Klasse 2 · Körper, Farben & Kleidung",
            words: [
                {de:"Kopf",foreign:"head"}, {de:"Schulter",foreign:"shoulder"}, {de:"Knie",foreign:"knee"}, {de:"Zeh",foreign:"toe"}, {de:"Auge",foreign:"eye"}, {de:"Ohr",foreign:"ear"}, {de:"Nase",foreign:"nose"}, {de:"Mund",foreign:"mouth"}, {de:"Hand",foreign:"hand"}, {de:"Fuß",foreign:"foot"}, {de:"rot",foreign:"red"}, {de:"blau",foreign:"blue"}, {de:"gelb",foreign:"yellow"}, {de:"grün",foreign:"green"}, {de:"schwarz",foreign:"black"}, {de:"weiß",foreign:"white"}, {de:"rosa",foreign:"pink"}, {de:"orange",foreign:"orange"}, {de:"braun",foreign:"brown"}, {de:"Hut",foreign:"hat"}, {de:"Mantel",foreign:"coat"}, {de:"Kleid",foreign:"dress"}, {de:"Hose",foreign:"trousers"}, {de:"Hemd",foreign:"shirt"}, {de:"Schuhe",foreign:"shoes"}, {de:"Socken",foreign:"socks"}
            ]
        },
        k3: {
    ...
    tr: {
        k1: {
            ...
            words: [
                {de:"Vater",foreign:"baba"}, {de:"Mutter",foreign:"anne"}, {de:"Geschwister",foreign:"kardeş"}, {de:"Baby",foreign:"bebek"}, {de:"Haus",foreign:"ev"}, {de:"Baum",foreign:"ağaç"}, {de:"Blume",foreign:"çiçek"}, {de:"Sonne",foreign:"güneş"}, {de:"Mond",foreign:"ay"}, {de:"Stern",foreign:"yıldız"}, {de:"Hund",foreign:"köpek"}, {de:"Katze",foreign:"kedi"}, {de:"Fisch",foreign:"balık"}, {de:"Vogel",foreign:"kuş"}, {de:"Milch",foreign:"süt"}, {de:"Brot",foreign:"ekmek"}, {de:"Wasser",foreign:"su"}, {de:"Apfel",foreign:"elma"}, {de:"Auto",foreign:"araba"}, {de:"Flugzeug",foreign:"uçak"}, {de:"Schiff",foreign:"gemi"}, {de:"Zug",foreign:"tren"}
            ]
        },
        k2: {
            label: "Klasse 2 · Vücut, Renkler ve Kıyafetler (Körper, Farben & Kleidung)",
            words: [
                {de:"Kopf",foreign:"baş"}, {de:"Auge",foreign:"göz"}, {de:"Ohr",foreign:"kulak"}, {de:"Nase",foreign:"burun"}, {de:"Mund",foreign:"ağız"}, {de:"Hand",foreign:"el"}, {de:"Fuß",foreign:"ayak"}, {de:"Schulter",foreign:"omuz"}, {de:"Knie",foreign:"diz"}, {de:"Zeh",foreign:"ayak parmağı"}, {de:"rot",foreign:"kırmızı"}, {de:"blau",foreign:"mavi"}, {de:"grün",foreign:"yeşil"}, {de:"gelb",foreign:"sarı"}, {de:"schwarz",foreign:"siyah"}, {de:"weiß",foreign:"beyaz"}, {de:"rosa",foreign:"pembe"}, {de:"orange",foreign:"turuncu"}, {de:"braun",foreign:"kahverengi"}, {de:"Hut",foreign:"şapka"}, {de:"Mantel",foreign:"mont"}, {de:"Kleid",foreign:"elbise"}, {de:"Hose",foreign:"pantolon"}, {de:"Hemd",foreign:"gömlek"}, {de:"Schuhe",foreign:"ayakkabı"}, {de:"Socken",foreign:"çorap"}
            ]
        },
        k3: {
